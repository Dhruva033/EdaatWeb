/**
*
* Test Script Name                      : BillerReceivablesReportsCustomReconciliationReportVerifyAvailablePaymentMethods.
* Test Data Sheet                       : BillerCustomReportPaymentMethod.
* Objective                             : Verify that the Payment Method appears depends on the payment method checked in the biller account under Reports Module.
* Version                               : 1.0
...
public class BillerReceivablesReportsCustomReconciliationReportVerifyAvailablePaymentMethods {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerCustomReportPaymentMethod";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesReportsCustomReconciliationReportVerifyAvailablePaymentMethods(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            Pages.BillerReportsCustomReconciliationReportPage.verifyAvailablePaymentMethodAssignedToBillerAccount(testdatamap,Log);
