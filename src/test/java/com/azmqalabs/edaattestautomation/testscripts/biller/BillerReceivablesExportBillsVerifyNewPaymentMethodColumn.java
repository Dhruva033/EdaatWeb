/**
*
* Test Script Name                      : BillerReceivablesExportBillsVerifyNewPaymentMethodColumn.
* Test Data Sheet                       : BillerReceivExportBillsPayment.
* Objective                             : Verify Add new columns in Exported bills page for the payment method under Receivables Module.
* Version                               : 1.0
...
public class BillerReceivablesExportBillsVerifyNewPaymentMethodColumn {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceivExportBillsPayment";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportBillsVerifyNewPaymentMethodColumn(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            Pages.BillerReceivablesExportedbillsPage.verifyNewPaymentMethodColumnIsAdded(Log);
