/**
*
* Test Script Name                      : BillerReceCusRecReportsCheckingandUncheckingReportFieldsViewChangesInGridColumns.
* Test Data Sheet                       : BillerRecReportCheckandUncheck.
* Objective                             : Verify that when checking/Unchecking the fields will appearand disappear in the grid.
* Version                               : 1.0
...
public class BillerReceCusRecReportsCheckingandUncheckingReportFieldsViewChangesInGridColumns {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerRecReportCheckandUncheck";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceCusRecReportsCheckingandUncheckingReportFieldsViewChangesInGridColumns(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            Pages.BillerReportsCustomReconciliationReportPage.validateCheckingAndUncheckingReportsCheckboxChangesInGridData(testdatamap,Log);	            
