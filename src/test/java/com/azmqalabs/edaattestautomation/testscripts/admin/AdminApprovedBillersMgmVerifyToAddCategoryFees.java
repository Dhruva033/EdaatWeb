  /**
* Test Script Name                   : AdminApprovedBillersMgmVerifyToAddCategoryFees
* Test Data Sheet Name				 : AdmApprBilMgmCategoryFees
* Objective                          : 1)Verify that AZM fees can be define as category by (invoice amount/transaction count) under System Management module
* 									 : 2)Verify that the  priority is for category fees when  deduction AZM fees under System Management module
* Version                            : 1.0
* Author                             : Kathirvelu Mohan
* Created Date                       : 30/04/2024
* Last Updated on                    : N/A
* Updated By                         : Dhruva Kumar S
* Pre-Conditions                     : 1)Valid Admin Login Credentials 2)Biller Registration
* Epic Details                       : N/A
...
public class AdminApprovedBillersMgmVerifyToAddCategoryFees {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdmApprBilMgmCategoryFees";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminApprovedBillersMgmVerifyToAddCategoryFees(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMangement.navigateBillersUnderActivation(Log);
	        	...
	        	Pages.AdminApprovedBillerManagement.verifyToAddCategoryFees(testdatamap,Log);
