...
* Objective                             : Verify Forget Password page Field validation
* Version                               : 1.0
...
public class ClientLoginForgotPwd {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientForgotPwd";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientLoginForgotPwd(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step2 : Verify Forget Password link on the login page is successfull");
	        	Pages.ClientLoginPage.forgotPasswordErrormessageValidation(testdatamap);
