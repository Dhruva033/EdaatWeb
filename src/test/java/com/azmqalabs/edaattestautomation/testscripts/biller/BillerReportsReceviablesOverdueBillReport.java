/**
* Test Script Name  				 : BillerReportsReceviablesOverdueBillReport.
*TestDataSheet                       : BillerSystemMgmtApproved
* Objective     					 : To Verify Clients Invoices Report.
* Version      						 : 1.0
...
public class BillerReportsReceviablesOverdueBillReport {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerOverdueBillsReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReportsReceviablesOverdueBillReport(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReportsReceivablesReportPage.NavigatetoOverdueBillsReport(Log);
	        	Pages.BillerReportsReceivablesReportPage.VerifyOverdueBillsReport(testdatamap, Log);
