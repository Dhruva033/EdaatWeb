/**
* Test Script Name                      : BillerSubbillerCorporateSubAdd.
* Test Data Sheet                       : BillerCorporateSubAdd.
* Objective                             : Verify to add sub Biller with Fees Deduction from Invoice Total Amount
* Version                               : 1.0
...
public class BillerSubbillerCorporateProductErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerCorporateSubAddProdUi";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSubbillerCorporateProductErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Corporate Subbiller page is dispayed Suceessfull");
	        	Pages.BillerSubbillerPage.NavigateCorporateSubBiller(Log);
	        	
	        	Log.ReportEvent("INFO", "Step4 : Verify Add Corporate Subbiller functionality is Suceessfull");
	        	Pages.BillerSubbillerPage.AddCorporateSubBillerwithProductUi(testdatamap);
