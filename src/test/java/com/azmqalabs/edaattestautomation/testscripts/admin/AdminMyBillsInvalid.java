/**
* Test Script Name                   : AdminMyBillsInvalid
* Test Data Sheet Name				 : MyBillsInvalid
* Objective                          : Verify to enter Invalid Invoice Number Under My Bills module
* Version                            : 1.0
...
* Pre-Conditions                     : 1)Valid Admin Login Credentials
 									 : 2)Invalid Bill Number should be present
* Epic Details                       : N/A
...
import com.azmqalabs.edaattestautomation.common.SendEmail;
...
public class AdminMyBillsInvalid {
	
	// DECLARATION SECTION
	  static String TestDataTab="MyBillsInvalid";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminMyBillsInvalid(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.MyBillsPage.verifyInvalidBillNumberMessage(testdatamap,Log);
