/**
* Test Script Name  				 : BillerSettingsContentMngUploadBulkData
...
public class BillerSettingsContentMngUploadBulkData {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSettingsContentMng";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsContentMngUploadBulkData(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsPage.VerifyToUploadBulkData(testdatamap,Log);
