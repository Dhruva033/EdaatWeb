/**
* Test Script Name  				 : BillerSettingsAddTermsManagements.
* TestDataSheetName					 : BillerTermsManagement
...
public class BillerSettingsAddTermsManagements{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerTermsManagement";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsAddTermsManagements(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingTermsManagementPage.VerifyToaddActiveTerm(testdatamap, Log);
