/**
* Test Script Name  				 : BillerSettingsViewTermsManagements.
* TestDataSheetName					 : BillerViewTermsManagement
* Objective     					 : To Verify to View term and Activate under Terms Management
* Version      						 : 1.0
...
public class BillerSettingsViewTermsManagements{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerViewTermsManagement";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsViewTermsManagements(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingTermsManagementPage.VerifyToviewActiveTerm(testdatamap, Log);
