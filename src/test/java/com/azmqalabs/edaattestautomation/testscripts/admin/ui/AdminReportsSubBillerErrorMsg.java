/**
*
* Test Script Name                   : AdminReportsSubBillerErrorMsg 
* TestData Sheet Name                : AdminSubBillerReportErrMsg
* Objective                          : Verify Sub biller report error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminReportsSubBillerErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminSubBillerReportErrMsg";  
	...
	public AdminReportsSubBillerErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminReportsAdminReportsPage.VerifySubBillesrReportErrorMsg(testdatamap,Log);
