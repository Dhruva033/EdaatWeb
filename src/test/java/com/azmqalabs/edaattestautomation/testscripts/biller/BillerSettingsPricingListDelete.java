/**
*
* Test Script Name                   : BillerSettingsPricingListDelete
* TestDataSheet                      : BillerPriceListDelete
* Objective                          : Verify to delete price list Functionality.
* Version                            : 1.0
* Author                             : Kathirvelu Mohan
* Created Date                       : 11/08/2023
* Last Updated on                    : N/A
* Updated By                         : Obalanayak M S
* Pre-Conditions                     : Active Biller Account Details and Pricelist Details
* Epic Details                       : N/A
...
public class BillerSettingsPricingListDelete {
	
	// DECLARATION SECTION
		  static String TestDataTab="BillerPriceListDelete";  
		  ...
		  DBUtil DBUtil;
		    ...
		    public  BillerSettingsPricingListDelete(Map<Object, Object> testdatamap){
...
//		    @Parameters({ "username", "password" })
		    ...
		    public void myTest() throws InterruptedException, Exception{
		        try{
		        	...
		        	Pages.BillerSettingPricelistPage.PriceListDelete(testdatamap,Log);
