/**
*
* Test Script Name                      : BillerReceivablesExportBillsVerifyMaxLengthOfTransferRemarkFeild
* Test Data Sheet                       : BillerTransferRemarkFeildMaxLen
* Objective                             : verify that text length is free text with max length 280 char
* Version                               : 1.0
...
public class BillerReceivablesExportBillsVerifyMaxLengthOfTransferRemarkFeild {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerTransferRemarkFeildMaxLen";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportBillsVerifyMaxLengthOfTransferRemarkFeild(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            Pages.BillerReceivablesExportedbillsPage.verifyMaxLengthOfTransferRemarkField(testdatamap, Log);
