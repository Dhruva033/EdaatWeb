/**
* Test Script Name                   : MyBillsValidateTheClientPopupAppears
* Test Data Sheet Name				 : MyBillsClientPopup
* Objective                          : verify that when clicking on inquire about invoice button after entering the contract number redirects to login to the client account under My Bills module
* Version                            : 1.0
...
public class MyBillsValidateTheClientPopupAppears {
	
	// DECLARATION SECTION
	  static String TestDataTab="MyBillsClientPopup";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public MyBillsValidateTheClientPopupAppears(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.MyBillsPage.validateTheClientPopupAppears(testdatamap,Log);
