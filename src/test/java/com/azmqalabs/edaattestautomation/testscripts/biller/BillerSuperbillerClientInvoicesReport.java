/**
*
* Test Script Name                   : BillerReportClientAccountStatement
* Test Data Sheet                    : BillerSuperClientInvoiceReport
* Objective                          : Verify to Generate client invoice report under Receivables of super biller.
* Version                            : 1.0
...
public class BillerSuperbillerClientInvoicesReport{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSuperClientInvoiceReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSuperbillerClientInvoicesReport(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReportReceivableReportforSuperBillerPage.GenerateReport(testdatamap, Log);
