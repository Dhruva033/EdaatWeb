/**
*
* Test Script Name                      : BillerSettingsProductManagementEdit
* TestDataSheet                         : BillerEditProduct
* Objective                             : Verify Edit Product functionality.
* Version                               : 1.0
* Author                                : Kathir Mohan
* Created Date                          : 29/05/2023
* Last Updated on                       : N/A
* Updated By                            : Obalanayak M S
* Pre-Conditions                        : Active Biller Account Details and Product Details
* Epic Details                          : N/A
...
public class BillerSettingsProductManagementEdit {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerEditProduct";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsProductManagementEdit(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingProductsManagementPage.VerifyEditFunctionality(testdatamap,Log);
