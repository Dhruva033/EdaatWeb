/**
* Test Script Name  				 : BillerReportsClientInvoicesReportGenerate.
* TestDataSheetName					 : BillerClientInvoicesReport
* Objective     					 : To Verify Clients Invoices Report under Receivable Reports.
* Version      						 : 1.0
...
public class BillerReportsClientInvoicesReportGenerate {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerClientInvoicesReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReportsClientInvoicesReportGenerate(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReportsReceivablesReportPage.navigatetoclientinvoicereport(Log);
	        	Pages.BillerReportsReceivablesReportPage.GenerateReport(testdatamap, Log);
