/**
*
* Test Script Name                   : BillerMyAccount
* Test Data Sheet                    : BillerMyAccount
* Objective                          : Verify Smstoggle Functionality under MyAccount Module.
* Version                            : 1.0
...
public class BillerMyAccount{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerMyAccount";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerMyAccount(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerMyAccountNotificationSettingPage.VerifySmstoggle(Log);
