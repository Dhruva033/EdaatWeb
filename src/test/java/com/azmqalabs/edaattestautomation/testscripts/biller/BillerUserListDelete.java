/**
*
* Test Script Name                   : BillerUserListDelete
* TestDataSheet                      : BillerUserListDelete
* Objective                          : Verify Deleted Users checkbox
* Version                            : 1.0
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerUserMngUserListPage.verifyDeleteUser(testdatamap,Log);
