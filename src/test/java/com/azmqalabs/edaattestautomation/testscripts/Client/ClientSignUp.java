/**
* Test Script Name                      : ClientSignUp.
* Test Data Sheet Name                  : ClientSignUp
* Objective                             : 1.Verify to Register new Client account with valid data.
                                          2.Verify the uploaded attachments.
                                          3.Verify to check the acknowledge and agree statement.
                                          4.Verify to check [I am not Robot] captcha.
                                          5.Verify to Activate the account through email.
* Version                               : 1.0
* Author                                : Kathirvelu M
* Created Date                          :
* Last Updated on                       : N/A
...
public class ClientSignUp {
	...
	// DECLARATION SECTION
	  static String TestDataTab="ClientSignUp";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientSignUp(Map<Object, Object> testdatamap){
