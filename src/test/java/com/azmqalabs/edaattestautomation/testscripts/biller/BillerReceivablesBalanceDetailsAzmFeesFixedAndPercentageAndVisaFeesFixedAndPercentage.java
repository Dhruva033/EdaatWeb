/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndVisaFeesFixedAndPercentage.
* Test Data Sheet                    : BillerReceVisaFeesFixAndPer
* Objective                          : Verify the fees deduction correctly in Balance details page when AZM Fees [ Fixed & Percentage] and Visa Fees[ Fixed & Percentage] under Receivables Balance details.
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndVisaFeesFixedAndPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceVisaFeesFixAndPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndVisaFeesFixedAndPercentage(Map<Object, Object> testdatamap){
