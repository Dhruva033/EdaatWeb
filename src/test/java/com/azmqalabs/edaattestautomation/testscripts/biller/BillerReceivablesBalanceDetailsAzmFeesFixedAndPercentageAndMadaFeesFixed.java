/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndMadaFeesFixed
* Test Data Sheet                    : BillerReceivablesMadaFeesFixed
* Objective                          : Verify the fees deduction correctly in Balance details page when AZM Fees [ Fixed & Percentage] and MADA Fees[ Fixed ] under Receivables Balance details.
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndMadaFeesFixed {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceivablesMadaFeesFixed";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndMadaFeesFixed(Map<Object, Object> testdatamap){
