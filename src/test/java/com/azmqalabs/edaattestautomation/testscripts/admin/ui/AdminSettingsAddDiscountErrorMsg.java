/**
*
* Test Script Name                   : AdminSettingsAddDiscountErrorMsg 
* TestData Sheet Name                : AdminAddDiscountErrorMsg
* Objective                          : Verify to add discount error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminSettingsAddDiscountErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminAddDiscountErrorMsg";  
	...
	public AdminSettingsAddDiscountErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			this.ArabicName=testdatamap.get("ArabicName").toString();
			this.EnglishName=testdatamap.get("EnglishName").toString();
			this.Percentage=testdatamap.get("Percentage").toString();
			...
			Log.ReportEvent("INFO", "Step3 : Verify Error message in Import client data is Suceessful");
			Pages.AdminSettingsDiscountPage.VerifyAddDiscountErrorMsg( ArabicName, Percentage, EnglishName,  ExpectedResult,Log);
