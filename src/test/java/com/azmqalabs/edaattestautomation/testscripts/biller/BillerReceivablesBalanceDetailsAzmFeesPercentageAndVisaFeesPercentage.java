...
* Test Data Sheet                    : BillerRecAzmFeesPerVisaPer
* Objective                          : Verify the fees deduction correctly  in Balance details page when AZM Fees [ Percentage] and Visa Fees[ Percentage].
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesPercentageAndVisaFeesPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerRecAzmFeesPerVisaPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesPercentageAndVisaFeesPercentage(Map<Object, Object> testdatamap){
