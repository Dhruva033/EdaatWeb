/**
*
* Test Script Name                   : BillerDownloadImportClientData
* Test Data SheetName				 : BillerImportclientdata
* Objective                          : Verify to download the bulk sheet under Import Client Data.
* Version                            : 1.0
* Author                             : Kathir M
...
* Manual Testcase Name               : BillerDownloadImportClientData.
* Epic Details                       : N/A
...
public class BillerDownloadImportClientData{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerImportclientdata";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerDownloadImportClientData(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerImportClientdataPage.downloadImportClientdata(testdatamap, Log);
