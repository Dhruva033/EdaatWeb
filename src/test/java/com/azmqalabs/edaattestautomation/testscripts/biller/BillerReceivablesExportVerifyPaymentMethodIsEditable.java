/**
*
* Test Script Name                      : BillerReceivablesExportVerifyPaymentMethodIsEditable.
* Test Data Sheet                       : BillerReceivExportBillsEditPaym.
* Objective                             : verify that the available payment methods is editable after the invoice partially paid under Receivables Module.
* Version                               : 1.0
...
public class BillerReceivablesExportVerifyPaymentMethodIsEditable {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceivExportBillsEditPaym";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportVerifyPaymentMethodIsEditable(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            Pages.BillerReceivablesExportedbillsPage.verifyPaymentMethodIsEditable(testdatamap, Log);
