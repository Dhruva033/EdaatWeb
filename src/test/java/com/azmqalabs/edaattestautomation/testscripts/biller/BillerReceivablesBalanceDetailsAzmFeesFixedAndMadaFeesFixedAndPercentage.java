...
public class BillerReceivablesBalanceDetailsAzmFeesFixedAndMadaFeesFixedAndPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAzmFeesFixMadaFeesFixPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedAndMadaFeesFixedAndPercentage(Map<Object, Object> testdatamap){
