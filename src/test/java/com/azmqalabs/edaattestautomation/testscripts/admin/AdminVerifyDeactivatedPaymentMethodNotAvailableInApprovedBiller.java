/**
*
* Test Script Name                   : AdminVerifyDeactivatedPaymentMethodNotAvailableInApprovedBiller
* Test Data Sheet Name				 : AdminPMStatusDeactivated
* Objective                          : Verify to Activate/Deactivate the payment method
* Version                            : 1.0
...
public class AdminVerifyDeactivatedPaymentMethodNotAvailableInApprovedBiller {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminPMStatusDeactivated";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminVerifyDeactivatedPaymentMethodNotAvailableInApprovedBiller(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            Pages.AdminSystemMangement.navigatePaymentMethodManagement(Log);	
	            
	            Pages.AdminSystemMangement.VerifyDeactivatePaymentMethodsStatusToggle(testdatamap,Log); 
	            ...
	            Pages.AdminApprovedBillerManagement.verifyDeactivatedPaymentMethodisNotAvailable(Log);
