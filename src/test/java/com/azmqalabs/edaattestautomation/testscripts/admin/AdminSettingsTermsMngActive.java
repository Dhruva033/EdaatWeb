 /**
* Test Script Name                   : AdminSettingsTermsMngActive.
* TestData sheet Name                : AdminAddTermActive.
* Objective                          : Verify to Add Term and Active in Terms Management under Settings.
* Version                            : 1.0
...
public class AdminSettingsTermsMngActive {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminAddTermActive";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsTermsMngActive(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingTermsManagementPage.navigateTerm(Log);
	        	
	        	Pages.AdminSettingTermsManagementPage.VerifyTermsMgnActive(testdatamap,Log);
