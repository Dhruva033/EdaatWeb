/**
*
* Test Script Name                   : BillerPayablesIncomingBillsValidateMultiPaymentStatusInPaymentMethodGrid
* Test Data Sheet                    : BillerPayables
* Objective                          : Verify pay installments invoice with multi payment methods .
* Version                            : 1.0
...
public class BillerPayablesIncomingBillsValidateMultiPaymentStatusInPaymentMethodGrid{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerPayVerifyMultiPayStatus";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerPayablesIncomingBillsValidateMultiPaymentStatusInPaymentMethodGrid(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerPayablesPage.validateMultiPaymentMethodStatusInIncomingBills(testdatamap, Log);
