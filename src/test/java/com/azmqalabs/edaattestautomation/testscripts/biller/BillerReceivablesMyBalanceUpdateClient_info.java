/**
* Test Script Name  				 : BillerReceivablesMyBalanceUpdateClient_info.
* Test Data Sheet                    : BillerMybalance.
* Objective     					 : Verify Update Client Information functionality under Receivables Balance details.
* Version      						 : 1.0
...
public class BillerReceivablesMyBalanceUpdateClient_info {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerMybalance";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesMyBalanceUpdateClient_info(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            Pages.BillerReceivablesBalancePage.UpdateClientInfo(testdatamap,Log);	        	
