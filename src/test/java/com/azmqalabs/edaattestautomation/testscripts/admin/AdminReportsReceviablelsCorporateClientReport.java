 /**
* Test Script Name                   : AdminReportsReceviablelsCorporateClientReport
* TestData sheet Name                : AdminReceiCorporateClientReport
* Objective                          : Verify Receivables Reports Corporate Clients Report
* Version                            : 1.0
...
public class AdminReportsReceviablelsCorporateClientReport {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReceiCorporateClientReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReportsReceviablelsCorporateClientReport(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReportsReceivablesReportsPage.VerifyCorporateClientReport(Log);
