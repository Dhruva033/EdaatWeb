/**
* Test Script Name  				 : AdminSysMgmBillerMgmAdminIsAbleToUpdateAddOrRemovePaymentMethods
* Test Data Sheet Name				 : AdminAbleToUpdateAddRemovePaymt
* Objective     					 : [Admin] Verify that the Admin is able to assign new payment method
* Version      						 : 1.0
* Author       						 : Kalpana I R
...
public class AdminSysMgmBillerMgmAdminIsAbleToUpdateAddOrRemovePaymentMethods {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminAbleToUpdateAddRemovePaymt";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSysMgmBillerMgmAdminIsAbleToUpdateAddOrRemovePaymentMethods(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminApprovedBillerManagement.VerifyAdminAbleToAddOrUpdatePaymentType(testdatamap,Log);
