...
public class BillerSubbillerCorporateSubAdd {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerCorporateSubAdd";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSubbillerCorporateSubAdd(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSubbillerPage.AddCorporateSubBiller(testdatamap, Log);
