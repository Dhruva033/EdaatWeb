/**
*
* Test Script Name                   : BillerMyAccountPushNotificationToggel
* Test Data Sheet Name				 : BillerMyAccountPushNotification
* Objective                          : Verify  Push Notifications toggel under MyAccount module
* Version                            : 1.0
...
public class BillerMyAccountPushNotificationToggel{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerMyAccountPushNotification";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerMyAccountPushNotificationToggel(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerMyAccountNotificationSettingPage.NavigatetoMyAccountNotificationSettings(Log);
	        	Pages.BillerMyAccountNotificationSettingPage.VerifyPushNotificationToggel(testdatamap, Log);
