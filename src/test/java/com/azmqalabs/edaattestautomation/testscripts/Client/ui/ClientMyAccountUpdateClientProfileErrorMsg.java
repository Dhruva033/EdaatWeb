/**
*
* Test Script Name                      : ClientMyAccountUpdateClientProfileErrorMsg.
* Objective                             : 1.Verify Update Client Profile Error Messages of all the text fields.
                                          2.Verify Update Client Profile Error Message of First Name text field.
                                          3.Verify Update Client Profile Error Message of Second Name text field.
                                          4.Verify Update Client Profile Error Message of Third Name text field.
                                          5.Verify Update Client Profile Error Message of Last Name text field.
                                          6.Verify Update Client Profile Error Messages of Date of birth and Date of birth hijiri text fields.
                                          7.Verify Update Client Profile Error Message of Mobile Number text field.
* Testdata Sheet Name                   : ClientUpdateClientProfileError.
* Version                               : 1.0
...
public class ClientMyAccountUpdateClientProfileErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientUpdateClientProfileError";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientMyAccountUpdateClientProfileErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step2 :Client Login is Succesfull");
	        	Pages.ClientLoginPage.LoginToApplication(testdatamap,Log);

	        	Log.ReportEvent("INFO", "Step3 :Verify to update client Profile & Close");
	        	Pages.ClientMyAccountPage.UpdateClientProfile(testdatamap);
