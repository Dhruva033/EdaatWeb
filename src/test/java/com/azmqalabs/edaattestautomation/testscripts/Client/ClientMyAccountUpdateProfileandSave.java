...
public class ClientMyAccountUpdateProfileandSave {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientUpdateandSaveProfile";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientMyAccountUpdateProfileandSave(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.ClientMyAccountPage.UpdateClientProfileSave(testdatamap, Log);
