...
* Test Data Sheet                    : BillerReportClientAccountstm
...
public class BillerReportClientAccountStatement{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReportClientAccountstm";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReportClientAccountStatement(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReportsReceivablesReportPage.ClientAccountReports(testdatamap, Log);
