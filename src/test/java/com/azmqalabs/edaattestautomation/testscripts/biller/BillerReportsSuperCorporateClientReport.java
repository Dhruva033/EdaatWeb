/**
* Test Script Name  				 : BillerReportsSuperCorporateClientReport
*TestDataSheet                       : BillerSuperCorpoClientReport
* Objective     					 : Verify Corporate Clients Report
* Version      						 : 1.0
...
public class BillerReportsSuperCorporateClientReport {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSuperCorpoClientReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReportsSuperCorporateClientReport(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	//Log.ReportEvent("INFO", "Step3 : Verify Navigate to Verify ClientInvoiceReport Generate is Suceessful");
	        	//Pages.BillerReportsReceivablesReportPage.navigatetoclientinvoicereport();
	        	Pages.BillerReportReceivableReportforSuperBillerPage.VerifyCorportaeClientsReport(testdatamap, Log);
