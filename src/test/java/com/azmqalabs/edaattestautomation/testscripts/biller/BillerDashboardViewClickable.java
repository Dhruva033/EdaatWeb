/**
* Test Script Name                   : BillerDashboardViewClickable
* Test Data  Sheet Name				 : BillerDashboardclick
* Objective                          : Verify the dashboards are clickable under dashboard page 
* Version                            : 1.0
...
public class BillerDashboardViewClickable {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerDashboardclick";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerDashboardViewClickable(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerDashboardPages.BillerDashboardclick(testdatamap, Log);
