/**
* Test Script Name                      : ClientGridViewInstallmentBills
* Test Data Sheet Name                  : ClientInstallmentGridView
...
public class ClientGridViewInstallmentBills {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientInstallmentGridView";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientGridViewInstallmentBills(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.ClientPayablesInstallmentsBillsPage.VerifyInstallmentgridView(Log);
