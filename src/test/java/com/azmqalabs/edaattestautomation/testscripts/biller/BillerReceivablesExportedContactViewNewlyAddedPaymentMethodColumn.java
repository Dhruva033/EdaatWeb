/**
*
* Test Script Name                      : BillerReceivablesExportedContactViewNewlyAddedPaymentMethodColumn.
* Test Data Sheet                       : BillerExportContViewNewGridClm.
* Objective                             : Verify Add new columns in Exported contracts page for the payment method .
* Version                               : 1.0
...
public class BillerReceivablesExportedContactViewNewlyAddedPaymentMethodColumn {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerExportContViewNewGridClm";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportedContactViewNewlyAddedPaymentMethodColumn(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.verifyNewlyAddedPaymentMethodColumnInGrid(Log);	        	
