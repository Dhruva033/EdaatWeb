/**
*
* Test Script Name                      : ClientMyAccountUpdateClientLoginInfoErrorMsg.
* Testdata Sheet Name                   : UpdateClientLoginInfo
* Objective                             : Verify update client Login Info Error Messages under My account module.
* Version                               : 1.0
...
public class ClientMyAccountUpdateClientLoginInfoErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="UpdateClientLoginInfo";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientMyAccountUpdateClientLoginInfoErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 :Verify update client Login Info Error Message validation is successfull");
	        	Pages.ClientMyAccountPage.UpdateClientLoginInfoError(testdatamap);
