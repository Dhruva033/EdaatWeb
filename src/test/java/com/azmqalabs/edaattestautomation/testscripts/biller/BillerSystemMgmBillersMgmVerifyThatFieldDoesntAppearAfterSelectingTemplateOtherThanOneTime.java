/**
* Test Script Name                   : BillerSystemMgmBillersMgmVerifyThatFieldDoesntAppearAfterSelectingTemplateOtherThanOneTime
* Objective                          : Verify the field doesn't appear when you choose any template other than the One Time template under System Management module
* Version                            : 1.0
...
public class BillerSystemMgmBillersMgmVerifyThatFieldDoesntAppearAfterSelectingTemplateOtherThanOneTime {
	
	// DECLARATION SECTION
	  static String TestDataTab="BilSysMgmBillMgmFieldDoesntAppe";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSystemMgmBillersMgmVerifyThatFieldDoesntAppearAfterSelectingTemplateOtherThanOneTime(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
		        ...
		        Pages.BillerReceivablesExportedbillsPage.VerifyTransferRemarkFieldDoesntAppearAfterSelectingTemplateOtherThanOneTime(testdatamap, Log);
