/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesFixedMasterFeesFixedAndPercentage.
* Test Data Sheet                    : BillerAzmFixedMasterFixedPercen
* Objective                          : [Biller-admin]Verify the fees deduction correctly  in Balance details page when AZM Fees [ Percentage] and Master Fees[ Percentage]
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesFixedMasterFeesFixedAndPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAzmFixedMasterFixedPercen";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedMasterFeesFixedAndPercentage(Map<Object, Object> testdatamap){
