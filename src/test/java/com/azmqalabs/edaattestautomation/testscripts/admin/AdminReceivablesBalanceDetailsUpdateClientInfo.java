/**
*
* Test Script Name                   : AdminReceivablesBalanceDetailsUpdateClientInfo.
* TestData Sheet Name                : AdminReceivableUpdateclientInfo
* Objective                          : Verify Update Client Information functionality under Receivables module.
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminReceivablesBalanceDetailsUpdateClientInfo {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReceivableUpdateclientInfo";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReceivablesBalanceDetailsUpdateClientInfo(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReceivablesBalancePage.naviagteBalanceDetails(Log);
	        	
	        	Pages.AdminReceivablesBalancePage.UpdateClientInfo(testdatamap,Log);
