/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageMadaFeesFixedAndPercentage.
* Test Data Sheet                    : BillerAzmMadaFixedPercentage
* Objective                          : Verify the fees deduction correctly in Balance details page when AZM Fees [ Fixed & Percentage] and MADA Fees[ Fixed & Percentage]
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageMadaFeesFixedAndPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAzmMadaFixedPercentage";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageMadaFeesFixedAndPercentage(Map<Object, Object> testdatamap){
