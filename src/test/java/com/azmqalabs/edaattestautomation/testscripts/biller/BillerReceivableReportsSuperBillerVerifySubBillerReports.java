/**
* Test Script Name  				 : BillerReceivableReportsSuperBillerVerifySubBillerReports
* Test Data Sheet Name				 : BillerReportsSubBillerReports
* Objective     					 : To Verify Sub Billers Report under Reports module
* Version      						 : 1.0
...
public class BillerReceivableReportsSuperBillerVerifySubBillerReports {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSuperBillSubBillerReports";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivableReportsSuperBillerVerifySubBillerReports(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReportReceivableReportforSuperBillerPage.NavigatetoReceivableReportSuperBiller(Log);
	        	Pages.BillerReportReceivableReportforSuperBillerPage.VerifySubBillersReport(testdatamap, Log);
