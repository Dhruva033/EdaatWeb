/**
* Test Script Name  				 : BillerAPIdocVerify.
* Test Data sheet Name				 : BillerAPIdocument.
...
public class BillerAPIdocVerify {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAPIdocument";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerAPIdocVerify(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerAPIdocumentPage.VerifyExportAPIdoc(Log);
