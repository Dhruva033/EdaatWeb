...
public class BillerReceivablesBalanceDetailsAzmFeesFixedPercentageAndSadadFeesFixed {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAzmFeesFixPerAndSadadFix";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedPercentageAndSadadFeesFixed(Map<Object, Object> testdatamap){
