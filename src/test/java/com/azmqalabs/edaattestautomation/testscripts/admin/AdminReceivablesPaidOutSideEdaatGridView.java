/**
* Test Script Name                   : AdminAddCorporateClient
* Objective                          : Verify to enter valid Invoice Number under receivables module.
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminReceivablesPaidOutSideEdaatGridView {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReceivablesPaidOutSideGrid";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReceivablesPaidOutSideEdaatGridView(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReceivablesPaidOutsideEdaatPage.GridView(testdatamap,Log);
