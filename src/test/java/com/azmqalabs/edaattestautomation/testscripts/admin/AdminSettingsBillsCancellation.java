/**
* Test Script Name                      : AdminSettingsBillsCancellation.
* TestDataSheet                         : AdminSettingsBillsCancellation
...
public class AdminSettingsBillsCancellation {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSettingsBillsCancellation";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsBillsCancellation(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsPage.VerifyUploadBulkData(Log);
