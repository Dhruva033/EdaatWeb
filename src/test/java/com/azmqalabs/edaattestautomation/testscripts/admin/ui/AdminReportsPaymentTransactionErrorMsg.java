/**
*
* Test Script Name                   : AdminReportsPaymentTransactionErrorMsg 
* TestData Sheet Name                : AdminPaymentTransactionErrMsg
* Objective                          : Verify Payment Transaction report error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminReportsPaymentTransactionErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminPaymentTransactionErrMsg";  
	...
	public AdminReportsPaymentTransactionErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminReportsAdminReportsPage.VerifyPaymentTransactionReportErrorMsg(testdatamap,Log);
