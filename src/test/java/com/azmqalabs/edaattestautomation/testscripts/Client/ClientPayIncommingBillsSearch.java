/**
* Test Script Name                      : ClientLoginVerifyForgotPwd
* Test Data Sheet Name                  : ClientForgotPwd
* Objective                             : Verify Forget Password link on the login page
* Version                               : 1.0
* Author                                : Dhruva Kumar S
* Created Date                          : 
* Last Updated on                       : N/A
* Updated By                            :
* Pre-Conditions                        : 1)Valid Email id should be present
* Epic Details                          : N/A
...
public class ClientPayIncommingBillsSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientPayIncomingBillsSearch";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientPayIncommingBillsSearch(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.ClientPayablesIncomingBillsPage.SearchIncomingBills(testdatamap,Log);
