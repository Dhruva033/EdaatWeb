/**
* Test Script Name  				 : BillerDetailsUpdate.
...
* Manual Test case Name				 : BillerDetailsUpdate.
* Epic Details						 : N/A
...
public class BillerIndividualClientReport {
	
	// DECLARATION SECTION
	  static String TestDataTab="IndividualClientReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerIndividualClientReport(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReportsReceivablesReportPage.VerifyIndividualClientsReport(testdatamap, Log);
