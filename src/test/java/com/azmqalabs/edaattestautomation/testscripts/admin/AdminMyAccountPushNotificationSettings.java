/**
*
* Test Script Name                   : AdminMyAccountPushNotificationSettings
* TestData Sheet Name                : AdminPushNotificationSettings
* Objective                          : Verify  Push Notifications toggle Under Notification Settings 
* Version                            : 1.0
...
public class AdminMyAccountPushNotificationSettings {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminPushNotificationSettings";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminMyAccountPushNotificationSettings(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminMyAccountPage.pushNotificationstoggle(testdatamap,Log);
