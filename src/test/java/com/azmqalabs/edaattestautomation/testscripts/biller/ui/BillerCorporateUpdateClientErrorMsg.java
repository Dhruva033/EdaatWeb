/**
* Test Script Name  				 : BillerCorporateUpdateClient.
* Test Data SheetName				 : BillerEditCorporateClientErr.		
* Objective     					 : Verify edit Corporate client page fields validation.
* Version      						 : 1.0
...
public class BillerCorporateUpdateClientErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerEditCorporateClientErr";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerCorporateUpdateClientErrorMsg(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Upadate Corporate Client Page fields validation is successful");
	        	Pages.BillerCorporatePage.VerifyEditCorpClietErrorMsg(CorporateName,PersonName,PersonID,MobileNo,Email,ClientRefno,ExpectedResult);
