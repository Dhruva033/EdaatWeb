/**
*
* Test Script Name                   : AdminSettingsInvoicesTemplatesView.
* TestData Sheet Name                : AdminInvoiceTemplateView
* Objective                          : Verify view Invoice details button.
* Version                            : 1.0
* Author                             : Kathirvelu M
...
* Pre-Conditions                     : 1)Admin Logged in with valid Credentials. 
                                       2)Invoice template should be present.
* Epic Details                       : N/A
	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsPage.navigateTemplate(Log);
	        	
	        	Pages.AdminSettingsPage.verfiyViewInvoiceTemplate(testdatamap,Log);
