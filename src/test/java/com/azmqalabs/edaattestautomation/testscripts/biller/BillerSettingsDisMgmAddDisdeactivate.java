/**
*
* Test Script Name                   : BillerSettingsDisMgmAddDisdeactivate
* TestDataSheet                      : BillerSettingsDisMgmAddDisdeact
* Objective                          : Verify to add discount & De-Activate. 
* Version                            : 1.0
* Author                             : Kathirvelu Mohan
* Created Date                       : 16/08/2023
* Last Updated on                    : N/A
* Updated By                         : Obalanayak M S
* Pre-Conditions                     : 1)Active Biller Login Credentials.
* Epic Details                       : N/A
...
public class BillerSettingsDisMgmAddDisdeactivate {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSettingsDisMgmAddDisdeact";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsDisMgmAddDisdeactivate(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsDiscountPage.AddDiscountDeactivate(testdatamap,Log);
