...
public class BillerSubBillerIndividualInvoiceErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BlrSubBlrAddIndividualinvoiceUi";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSubBillerIndividualInvoiceErrorMsg(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSubbillerPage.AddIndSubBillerUi(testdatamap);
