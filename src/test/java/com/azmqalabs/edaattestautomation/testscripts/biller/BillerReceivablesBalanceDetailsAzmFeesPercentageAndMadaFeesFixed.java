/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesPercentageAndMadaFeesFixed
* Test Data Sheet                    : BillerRecAzmFeesPerMadaFixed
* Objective                          : Verify the fees deduction correctly  inBalance details page when AZM Fees [ Percentage] and MADA Fees[ Fixed].
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesPercentageAndMadaFeesFixed {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerRecAzmFeesPerMadaFixed";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesPercentageAndMadaFeesFixed(Map<Object, Object> testdatamap){
