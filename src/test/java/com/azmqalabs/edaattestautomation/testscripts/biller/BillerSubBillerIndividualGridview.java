/**
*
* Test Script Name                   : BillerSubBillerIndividualGridview.
* Test Data Sheet                    : BillerSubBillerIndividualGrid
* Objective                          : Verify Grid details view in Individual subbiller under Subbiller module.
* Version                            : 1.0
...
public class BillerSubBillerIndividualGridview {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSubBillerIndividualGrid";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSubBillerIndividualGridview(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSubbillerPage.SubBillerIndividualGridView(EdaatOR.Biller_subBiller_individual_link,EdaatOR.Biller_subBiller_individual_grid, Log);
