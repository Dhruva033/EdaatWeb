/**
* Test Script Name  				 : BillerSettingsAddTermsManagementsErrorMsg.
* TestDataSheetName					 : BillerAddTermsUI
* Objective     					 : To Verify to add term and Activate under Terms Management
* Version      						 : 1.0
* Author       						 : Kathirvelu M
* Created Date 			      		 : 
* Last Updated on					 : N/A
...
public class BillerSettingsAddTermsManagementsErrorMsg{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAddTermsUI";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsAddTermsManagementsErrorMsg(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify navigate to termsmanagement is Successful");
	        	Pages.BillerSettingTermsManagementPage.navigatetoTermsManagement(Log);
	        
	        	Log.ReportEvent("INFO", "Step4 : Verify add term and Activate is Successful");
	        	Pages.BillerSettingTermsManagementPage.AddTermErrorMessageValidation(testdatamap);
