/**
*
* Test Script Name                      : BillerReceivablesReportsCustomReconciliationReportVerifyRetrievedData.
* Test Data Sheet                       : BillerCustomReportRetrieveData.
* Objective                             : Verify the fields name in AR&En interface under Reports Module
* Version                               : 1.0
...
public class BillerReceivablesReportsCustomReconciliationReportVerifyRetrievedData {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerCustomReportRetrieveData";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesReportsCustomReconciliationReportVerifyRetrievedData(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            Pages.BillerReportsCustomReconciliationReportPage.verifyToObserveTheRetrievedData(testdatamap,Log);
