/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesFixedAndSadadFeesFixed
* Test Data Sheet                    : BillerRecAzmFeesFixedSadadFixed
* Objective                          : Verify  the fees deduction correctly in   Balance details page when AZM Fees [ Fixed] and Sadad Fees[ Fixed ].
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesFixedAndSadadFeesFixed {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerRecAzmFeesFixedSadadFixed";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedAndSadadFeesFixed(Map<Object, Object> testdatamap){
