/**
* Test Script Name  				 : BillerSettingsAddDiscountActivateErrorMsg.
* TestDataSheet                      : BillerAddDiscount
* Objective     					 : Verify to add discount & Activate 
* Version      						 : 1.0
...
public class BillerSettingsAddDiscountActivateErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAddDiscount";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsAddDiscountActivateErrorMsg(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Navigate to Discount page is Suceessfull");
	        	Pages.BillerSettingsDiscountPage.navigateDisCountPage(Log);
	        
	        	Log.ReportEvent("INFO", "Step3 : Verify to add discount and activate Suceessfull");
	        	Pages.BillerSettingsDiscountPage.AddDiscountErrorMessageValidation(testdatamap);
