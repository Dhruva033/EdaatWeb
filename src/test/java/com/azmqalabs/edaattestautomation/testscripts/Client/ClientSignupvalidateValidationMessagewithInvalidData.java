/**
* Test Script Name                      : ClientMyAccountUpdateProfileandSave
* Test Data Sheet Name                  : ClientUpdateandSaveProfile
* Objective                             : Verify to update client Profile & Save
* Version                               : 1.0
* Author                                : Kathirvelu Mohan
* Created Date                          : 
* Last Updated on                       : N/A
* Updated By                            : Obalanayak M S
* Pre-Conditions                        : Active Client Login Credentials Should be Present
* Epic Details                          : N/A
...
public class ClientSignupvalidateValidationMessagewithInvalidData {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientSignUpinvalid";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientSignupvalidateValidationMessagewithInvalidData(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.ClientSignUpPage.ClientRegisterwithInvalidData(testdatamap,Log);
