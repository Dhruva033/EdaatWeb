/**
*
* Test Script Name                      : BillerReceivablesVerifyTransferRemarkFieldNotAppearsBySelectingOtherTemplate.
* Test Data Sheet                       : BillerReceTRFieldNotAppears.
* Objective                             : Verify create and save one time invoice Under Receivables module.
* Version                               : 1.0
...
public class BillerReceivablesVerifyTransferRemarkFieldNotAppearsBySelectingOtherTemplate {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceTRFieldNotAppears";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesVerifyTransferRemarkFieldNotAppearsBySelectingOtherTemplate(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.naviagteReveiableExportBiller(Log);     	        		        	
	           	Pages.BillerReceivablesExportedbillsPage.verifyTransferRemarkFieldNotAppears(testdatamap,Log);	           	       	
