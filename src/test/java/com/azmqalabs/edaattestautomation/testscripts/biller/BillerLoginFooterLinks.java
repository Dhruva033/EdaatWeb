/**
*
* Test Script Name                      : BillerLoginFooterLinks.
* Testdata Sheet Name                   : BillerLoginFooterLinks.
* Objective                             : Verify the linkes in the Footer page under login module.
* Version                               : 1.0
* Author                                : Kathirvelu mohan
* Created Date                          : 
* Last Updated on                       : N/A
* Updated By                            : Kalpana I R
* Pre-Conditions                        : 1)URL should be present.
* Epic Details                          : N/A
...
public class BillerLoginFooterLinks {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerLoginFooterLinks";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerLoginFooterLinks(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerLoginPage.footerlinks(Log);
