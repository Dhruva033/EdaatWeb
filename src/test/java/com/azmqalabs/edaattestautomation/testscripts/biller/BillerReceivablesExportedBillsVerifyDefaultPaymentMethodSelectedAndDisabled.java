/**
*
* Test Script Name                      : BillerReceivablesExportedBillsVerifyDefaultPaymentMethodSelectedAndDisabled.
* Test Data Sheet                       : DefaultPaymetSelectAndDisabled.
* Objective                             : Verify that the default payment method when creating an invoice is paid outside edaat it selected and disabled
* Version                               : 1.0
* Author                                : Kalpana I R
...
public class BillerReceivablesExportedBillsVerifyDefaultPaymentMethodSelectedAndDisabled {
	
	// DECLARATION SECTION
	  static String TestDataTab="DefaultPaymetSelectAndDisabled";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportedBillsVerifyDefaultPaymentMethodSelectedAndDisabled(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.naviagteReveiableExportBiller(Log);    
	           	...
	           	Pages.BillerReceivablesExportedbillsPage.verifyDefaultPaymentMethodIsSelectedAndDisabled(testdatamap,Log);	
