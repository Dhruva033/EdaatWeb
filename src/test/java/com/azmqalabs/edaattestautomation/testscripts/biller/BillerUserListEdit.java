/**
*
* Test Script Name                   : BillerUserListEdit
* TestDataSheet                      : BillerUserListEdit
* Objective                          : Verify Edit user functionality
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class BillerUserListEdit {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerUserListEdit";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerUserListEdit(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerUserMngUserListPage.verifyEditUser(testdatamap,Log);
