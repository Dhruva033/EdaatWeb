/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesPercentageAndMadaFeesFixedAndPercentage
* Test Data Sheet                    : BillerReceMadaFeesFixAndPer
* Objective                          : Verify the fees deduction correctly in  Balance details page when AZM Fees [ Percentage] and MADA Fees[ Fixed & Percentage] under Receivables Balance details.
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesPercentageAndMadaFeesFixedAndPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceMadaFeesFixAndPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesPercentageAndMadaFeesFixedAndPercentage(Map<Object, Object> testdatamap){
