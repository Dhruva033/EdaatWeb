...
public class BillerReceivablesBalanceSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceivablesBalanceSearch";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceSearch(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesBalancePage.BalanceSearch(testdatamap, Log);
