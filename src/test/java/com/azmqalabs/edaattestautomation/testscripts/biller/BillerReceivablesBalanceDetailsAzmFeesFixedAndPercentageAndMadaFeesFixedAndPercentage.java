/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndMadaFeesFixedAndPercentage
* Test Data Sheet                    : BillerReceAzmFixPerMadaFixPer
* Objective                          : Verify the fees deduction correctly in Balance details page when AZM Fees [ Fixed & Percentage] and MADA Fees[ Fixed & Percentage] under Receivables Balance details.
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndMadaFeesFixedAndPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceAzmFixPerMadaFixPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndMadaFeesFixedAndPercentage(Map<Object, Object> testdatamap){
