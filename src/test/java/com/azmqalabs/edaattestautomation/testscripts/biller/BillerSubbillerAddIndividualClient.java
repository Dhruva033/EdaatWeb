/**
*
* Test Script Name                   : BillerSubbillerAddIndividualClient.
* Test Data Sheet                    : BillerSubBilleradd.
* Objective                          : Verify to add Individual Subbiller Functionality.
* Version                            : 1.0
...
public class BillerSubbillerAddIndividualClient{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSubBilleradd";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSubbillerAddIndividualClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSubbillerPage.AddSubBiller(testdatamap, Log);
	        	Pages.BillerSubbillerPage.IndividualSearch(testdatamap, Log);
