...
public class BillerSubbillerCorporateErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSubbillerUi";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSubbillerCorporateErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSubbillerPage.AddCarpoSubbillerInvoicetotal();
