...
public class ClientValidateLinksInFooter {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientClickonFooterLinks";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientValidateLinksInFooter(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.InvokeApplicationPage.Chooseoptions1(Log);	
	           	...
	           	Pages.ClientLoginPage.VerifyLinksinFooterppage(Log);	        
