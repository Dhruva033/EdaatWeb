/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsVerifyInvoiceTotalAmountAndOperationalFees.
* Test Data Sheet                    : BillerVeifyInvoicePaidAmount.
* Objective                          : verify that the Reconciled Date in the Daily Reconciliation Report (sadad) retrieve data correctly.
* Version                            : 1.0
* Author                             : ArunKumar M S
...
public class BillerReceivablesBalanceDetailsVerifyInvoiceTotalAmountAndOperationalFees {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerVeifyInvoicePaidAmount";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsVerifyInvoiceTotalAmountAndOperationalFees(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReportsDailyReconciliationReportSadadPage.navigateToDailyReconciliationReportSadadPage(Log);
	        	Pages.BillerReportsDailyReconciliationReportSadadPage.verifyDailyReconciliationReportSADADAndGetInvoicePaidAmount(testdatamap, Log);
	        	String totalInvoiceAmount =Pages.BillerReportsDailyReconciliationReportSadadPage.getTotalInvoiceAmount();
	        	String operationalFees =Pages.BillerReportsDailyReconciliationReportSadadPage.getAmountOperationFees();
	        	Pages.BillerReportsDailyReconciliationReportSadadPage.switchToParentwindow();
	        	Pages.BillerReceivablesBalancePage.NavigateReceievableMyBalance(Log);
	        	Pages.BillerReceivablesBalancePage.validatePaidInvoiceAmountAndOperationalFeesOfDailyReconciliationReportsadad(testdatamap,Log,totalInvoiceAmount,operationalFees);
			  ...
			  catch (Exception e)
			  {
				  Log.takeScreenShot();
				  Log.PostTestStatus(TestScriptID);
				  Log.ReportEvent("PASS", "TEST EXECUTION INCOMPLETE"+e);
