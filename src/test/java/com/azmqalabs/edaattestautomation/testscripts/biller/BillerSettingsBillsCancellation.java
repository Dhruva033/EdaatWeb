/**
* Test Script Name                      : BillerSettingsBillsCancellation.
...
public class BillerSettingsBillsCancellation {
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsBillsCancellation(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsPage.VerifyUploadBulkData(Log);
