/**
* Test Script Name                   : AdminDeleteIndividualClient
* TestData Sheet Name                : AdminDeleteIndividualClient
...
public class AdminDeleteIndividualClient {
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminIndividualClientPage.DeleteIndividualClient(FullName,SecondName,ThirdName,LastName,NationalID,Year,Month,Date,MobileNo,Email,Refno, ResonforDelete,Log);
