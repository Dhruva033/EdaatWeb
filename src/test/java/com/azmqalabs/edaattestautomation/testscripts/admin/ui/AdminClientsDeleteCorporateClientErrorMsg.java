/**
* Test Script Name                   : AdminClientsDeleteCorporateClientErrorMsg
* TestData Sheet Name                : AdminDeleteCorporateClientErrMg
* Objective                          : Verify  delete corporate client error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminClientsDeleteCorporateClientErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminDeleteCorporateClientErrMg";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminClientsDeleteCorporateClientErrorMsg(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminCorporatePage.VerifyDeleteCorpClietErrorMsg(ExpectedResult);
