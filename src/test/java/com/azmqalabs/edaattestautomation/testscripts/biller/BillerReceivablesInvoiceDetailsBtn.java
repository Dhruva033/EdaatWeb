/**
*
* Test Script Name                      : BillerReceivablesInvoiceDetailsBtn.
* Test Data Sheet                       : BillerViewInvoiceDetailsBtn
* Objective                             : Verify Invoice Details button is clickable under Receivables module.
* Version                               : 1.0
...
public class BillerReceivablesInvoiceDetailsBtn {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerViewInvoiceDetailsBtn";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesInvoiceDetailsBtn(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesBalancePage.naviagteBalanceDetails(Log);
	            Pages.BillerReceivablesBalancePage.verifyViewInvoiceBtn(testdatamap, Log);
