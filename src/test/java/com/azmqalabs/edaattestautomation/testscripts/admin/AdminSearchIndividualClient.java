/**
*
* Test Script Name                   : AdminSearchIndividualClient.
* TestData Sheet Name                : AdminSearcgIndividualClient
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminIndividualClientPage.AdminSearchIndividualclientall(FullName,NationalID,Refno,Log);
