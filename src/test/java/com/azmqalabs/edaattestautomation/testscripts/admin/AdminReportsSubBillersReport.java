 /**
* Test Script Name                   : AdminReportsSubBillersReport
* TestData sheet Name                : AdminSubBillersReport
* Objective                          : Verify Sub Billers Report under Admin Reports
* Version                            : 1.0
* Author                             : Kathirvelu M
* Created Date                       : 
* Last Updated on                    : N/A
...
public class AdminReportsSubBillersReport {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSubBillersReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReportsSubBillersReport(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReportsAdminReportsPage.NavigateTOAdminReports(Log);
	        	
	        	Pages.AdminReportsAdminReportsPage.VerifySubBillersReport(testdatamap,Log);
