/**
*
* Test Script Name                      : BillerReceivablesExportContactVerifyToEditPaymentMethodForPartiallyPaidInvoices
* Test Data Sheet                       : BillerExportContractEditPayment
* Objective                             : verify that the payment methods is editable after the invoice partial paid
* Version                               : 1.0
...
public class BillerReceivablesExportContactVerifyToEditPaymentMethodForPartiallyPaidInvoices {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerExportContractEditPayment";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportContactVerifyToEditPaymentMethodForPartiallyPaidInvoices(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.naviagteReveiableExportContact(Log);	        	
	        	Pages.BillerReceivablesExportedbillsPage.verifyPaymentMethodIsEditableForExportedContracts(testdatamap, Log);	        	
