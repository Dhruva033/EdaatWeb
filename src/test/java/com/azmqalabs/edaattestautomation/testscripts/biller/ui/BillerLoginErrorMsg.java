...
* Objective                             : Verify to login with valid biller acount credentials.
* Version                               : 1.0
* Author                                : Kathirvelu M
...
public class BillerLoginErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerLoginUi";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerLoginErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step2 : Verify Biller invalid Login is Suceessfull");
	        	Pages.BillerLoginPage.InvalidLogin(testdatamap);
