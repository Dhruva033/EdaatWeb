/**
*
* Test Script Name                   : BillerReportsCorporateClientReport
* TestData Sheet                     : BillerReportCorpClientReport
* Objective                          : Verify to Generate Corporate client Report.
* Version                            : 1.0
* Author                             : Kathirvelu M
...
* Pre-Conditions                     : 1)Biller logged in with valid credentials
                                       2)Corporate clients should be present.
* Epic Details                       : N/A
...
public class BillerReportsCorporateClientReport{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReportCorpClientReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReportsCorporateClientReport(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReportsReceivablesReportPage.CorporateClientReport(Log);
