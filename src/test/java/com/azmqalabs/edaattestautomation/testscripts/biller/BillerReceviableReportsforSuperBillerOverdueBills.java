/**
* Test Script Name  				 : BillerReceviableReportsforSuperBillerOverdueBills.
*TestDataSheet                       : BillerSuperBillerOverdueBills
* Objective     					 : Verify Over Due Bills Report Under Receivables Reports for Super Biller Menu
* Version      						 : 1.0
* Author       						 : Basavaraj Mudnur
* Created Date 			      		 : 
* Last Updated on					 : N/A
* Updated By   			 			 : 
* Pre-Conditions					 : 1)Active Biller Login Credentials 2)Tracked Billers should be present
* Epic Details						 : N/A
...
public class BillerReceviableReportsforSuperBillerOverdueBills {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSuperBillerOverdueBills";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceviableReportsforSuperBillerOverdueBills(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReportReceivableReportforSuperBillerPage.NavigatetoReceivableReportSuperBillerOverDue(Log);
	        	Pages.BillerReportReceivableReportforSuperBillerPage.VerifyOverdueBillsReport(testdatamap, Log);
