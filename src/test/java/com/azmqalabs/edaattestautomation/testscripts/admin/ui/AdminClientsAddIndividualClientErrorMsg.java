/**
*
* Test Script Name                   : AdminClientsAddIndividualClientErrorMsg 
* TestData Sheet Name                : AdminAddIndividualClientErrorMg
* Objective                          : Verify to Add Individual Client error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminClientsAddIndividualClientErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminAddIndividualClientErrorMg";  
	...
	public AdminClientsAddIndividualClientErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Log.ReportEvent("INFO", "Step3 : Verify Error message in Add Individual Client is Suceessful");
			Pages.AdminIndividualClientPage.VerifyAddIndClietErrorMsg(FullName,SecondName,ThirdName,LastName,NationalID,Year,Month,Date,MobileNo,Email,Refno,ExpectedResult);
