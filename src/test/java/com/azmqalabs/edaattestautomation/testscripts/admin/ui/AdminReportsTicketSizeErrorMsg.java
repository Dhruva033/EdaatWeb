/**
*
* Test Script Name                   : AdminReportsTicketSizeErrorMsg 
* TestData Sheet Name                : AdminTicketSizeReportErrMsg
* Objective                          : Verify Ticket Size report error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminReportsTicketSizeErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminTicketSizeReportErrMsg";  
	...
	public AdminReportsTicketSizeErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminReportsAdminReportsPage.VerifyTicketSizeReportErrorMsg(testdatamap,Log);
