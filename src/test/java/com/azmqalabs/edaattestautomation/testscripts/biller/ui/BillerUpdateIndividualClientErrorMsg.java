/**
* Test Script Name                   : BillerUpdateIndividualClient
* Test Data Sheet Name				 : BillerUpdateIndividualClient
* Objective                          : Verify Edit Individual Client Functionality
* Version                            : 1.0
* Author                             : Kathirvelu M
* Created Date                       : 17/05/2023
* Last Updated on                    : N/A
* Updated By                         : Basavaraj Mudnur
* Pre-Conditions                     : 1)Maker Login Credentials 
* Epic Details                       : N/A
...
public class BillerUpdateIndividualClientErrorMsg {
	

	// DECLARATION SECTION
	  static String TestDataTab="BillerEditIndividualClientErrMg";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerUpdateIndividualClientErrorMsg(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Upadate Individual Client Page fields validation Suceessfull");
	        	Pages.BillerIndividualClientPage.VerifyEditIndClietErrorMsg(FullName,SecondName,ThirdName,LastName,NationalID,Year,Month,Date,MobileNo,Email,Refno,ExpectedResult);
