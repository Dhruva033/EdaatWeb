/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesPercentageAndMadaPercentage
* Test Data Sheet                    : BillerRecAzmFeesPerVisaFixedPer
* Objective                          : Verify the fees deduction correctly  in Balance details page when AZM Fees [ Percentage] and MADA Fees[ Percentage].
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesPercentageAndMadaFeesPercentage {
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesPercentageAndMadaFeesPercentage(Map<Object, Object> testdatamap){
