...
* Test Data Sheet                       : BillerCorporateSubAddProduct.
...
public class BillerSubbillerCorporateSubAddProduct {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerCorporateSubAddProduct";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSubbillerCorporateSubAddProduct(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSubbillerPage.AddCorporateSubBillerwithProduct(testdatamap, Log);
