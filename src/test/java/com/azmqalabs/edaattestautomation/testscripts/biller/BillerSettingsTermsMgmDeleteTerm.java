/**
*
* Test Script Name                      : BillerSettingsTermsMgmDeleteTerm.
* Objective                             : Verify delete term button under Settings module.
* Testdata Sheet Name                   : BillerSettingsTermsMgmDltTerm.
* Version                               : 1.0
* Author                                : Kalpana I R
* Created Date                          : 
* Last Updated on                       : N/A
...
*                                         2)Term details should be present
* Epic Details                          : N/A
...
public class BillerSettingsTermsMgmDeleteTerm {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSettingsTermsMgmDltTerm";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsTermsMgmDeleteTerm(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingTermsManagementPage.DeleteTermButton(testdatamap, Log);
