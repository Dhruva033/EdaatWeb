/**
*
* Test Script Name                      : BillerLoginForgetPassword.
* Test Data Sheet                       : BillerLoginforget
...
**/
	...
	public class BillerLoginForgetPasswordErrorMsg {
		
		// DECLARATION SECTION
	  static String TestDataTab="BillerLoginforgetUi";  
	...
	public BillerLoginForgetPasswordErrorMsg(Map<Object, Object> testdatamap){
		this.testdatamap=testdatamap;
	    this.TestScriptID=testdatamap.get("TestScriptID").toString();
	    this.sBrowserTestData=testdatamap.get("Browser").toString();
	    this.Username=testdatamap.get("UsernameErrormsg").toString();
	}
	 @Override
	...
	public void myTest() throws InterruptedException, Exception{
	    try{
	    	...
	    	//Actual Test steps
			  ...
			  Pages.BillerLoginPage.ForgetPasswordValidation(EdaatOR.LoginPage_Forgetlink,Username);
