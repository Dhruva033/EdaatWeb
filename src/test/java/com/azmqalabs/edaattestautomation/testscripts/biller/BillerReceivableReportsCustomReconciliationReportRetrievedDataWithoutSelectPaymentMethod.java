/**
* Test Script Name  				 : BillerReceivableReportsCustomReconciliationReportRetrievedDataWithoutSelectPaymentMethod
* Test Data Sheet Name				 : RetrievDataWithoutSelectPayment
* Objective     					 : Verify that the retrieved data when choosing From- To reconciliation date without selecting the payment method
* Version      						 : 1.0
* Author       						 : Kalpana I R
...
public class BillerReceivableReportsCustomReconciliationReportRetrievedDataWithoutSelectPaymentMethod {
	
	// DECLARATION SECTION
	  static String TestDataTab="RetrievDataWithoutSelectPayment";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivableReportsCustomReconciliationReportRetrievedDataWithoutSelectPaymentMethod(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReportsReceivablesReportPage.navigateToCustomReconciliationReportPage(Log);
	        	
	        	Pages.BillerReportsCustomReconciliationReportPage.VerifyTheReportToRetrievedDataWithoutSelectPaymentMethod(testdatamap, Log);
