/**
*
* Test Script Name                   : AdminSettingsAddPriceList 
* Test data sheet Name               : AdminSettingsAddPriceList
...
* Pre-Conditions                     : 1)Admin login credentials 
                                       2)Price details should be present.
* Epic Details                       : N/A
...
public class AdminSettingsAddPriceList {

	// DECLARATION SECTION
	static String TestDataTab="AdminSettingsAddPriceList";  
	...
	public AdminSettingsAddPriceList(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSettingsPricingListPage.AddPriceList(testdatamap,Log);
