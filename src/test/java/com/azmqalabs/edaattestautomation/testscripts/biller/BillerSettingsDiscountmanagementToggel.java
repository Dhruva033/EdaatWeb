/**
* Test Script Name                      : BillerSettingsDiscountmanagementToggel
* TestDataSheet                         : BillerDiscountToggel
* Objective                             : Verify status toggel functionaliy
* Version                               : 1.0
* Author                                : Kathirvelu Mohan
* Created Date                          : 10/08/2023
* Last Updated on                       : N/A
* Updated By                            : Obalanayak M S
* Pre-Conditions                        : 1)Biller Login Credentials 2)Discount record should be present in the table
* Epic Details                          : N/A
...
public class BillerSettingsDiscountmanagementToggel {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerDiscountToggel";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsDiscountmanagementToggel(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsDiscountPage.NavigateDiscountManagement(Log);
	        	
	        	Pages.BillerSettingsDiscountPage.VerifyDiscoutStatusToggel(testdatamap,Log);
