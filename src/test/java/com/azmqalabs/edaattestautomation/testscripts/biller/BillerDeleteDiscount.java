/**
* Test Script Name  				 : BillerDeleteDiscount.
*TestDataSheet                       : BillerDiscount
* Objective     					 : To Verify to delete the discount.
* Version      						 : 1.0
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsDiscountPage.verifyDeleteDiscount(testdatamap,Log);
