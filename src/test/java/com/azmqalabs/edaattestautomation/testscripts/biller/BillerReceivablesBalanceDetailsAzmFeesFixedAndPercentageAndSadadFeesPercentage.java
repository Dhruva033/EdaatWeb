/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndSadadFeesPercentage
* Test Data Sheet                    : BillerRecAzmFeesFixedPeSadadPer
* Objective                          : Verify the fees deduction correctly in Balance details page when AZM Fees [ Fixed & Percentage] and Sadad Fees[  Percentage].
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndSadadFeesPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerRecAzmFeesFixedPeSadadPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndSadadFeesPercentage(Map<Object, Object> testdatamap){
