/**
*
* Test Script Name                   : AdminSystemMagmtSearchTaxes.
* TestData sheet Name                : AdminSysMgmIndClientSearch
* Objective                          : Verify the search functionality under System Management module
* Version                            : 1.0
...
public class AdminSystemMagmtIndividualClientSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSysMgmIndClientSearch";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMagmtIndividualClientSearch(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMgmIndividualClientPage.NavigateIndividualClientManagement(Log);
	        	
	        	Pages.AdminSystemMgmIndividualClientPage.SearchIndividualClient(testdatamap,Log);
