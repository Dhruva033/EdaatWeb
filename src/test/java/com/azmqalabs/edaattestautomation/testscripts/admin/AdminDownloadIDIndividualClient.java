/**
*
* Test Script Name                   : AdminDownloadIDIndividualClient
...
* Pre-Conditions                     : 1)Admin login credentials 2)Individual Client should be present.
* Manual Testcase Name               : AdminDownloadIDIndividualClient
* Epic Details                       : N/A
...
public class AdminDownloadIDIndividualClient {
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminIndividualClientPage.Download(testdatamap,Log);
