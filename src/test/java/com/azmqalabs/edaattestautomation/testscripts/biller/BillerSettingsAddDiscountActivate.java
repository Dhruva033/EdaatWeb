/**
* Test Script Name  				 : BillerSettingsAddDiscountActivate.
...
public class BillerSettingsAddDiscountActivate {
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsAddDiscountActivate(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsDiscountPage.ActivateDiscount(testdatamap,Log);
