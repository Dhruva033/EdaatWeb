/**
* Test Script Name  				 : BillerReceivableReportsVerifyDataInDailyReconciliationReport
* Test Data Sheet Name				 : BillerDailyReconciliationReport
* Objective     					 : [Biller-admin]verify that the data appears correctly in columns by  the Daily Reconciliation Report (sadad)
* Version      						 : 1.0
* Author       						 : Kathirvelu Mohan
* Created Date 			      		 : 02/05/2024
* Last Updated on					 : N/A
* Updated By   			 			 : Radhika K R
* Pre-Conditions					 : Biller should be logged in
* Epic Details						 : N/A
...
public class BillerReceivableReportsVerifyDataInDailyReconciliationReport {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerDailyReconciliationReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivableReportsVerifyDataInDailyReconciliationReport(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReportsDailyReconciliationReportSadadPage.verifyDailyReconciliationReportSADAD(testdatamap,Log);
	            Pages.BillerReceivablesExportedbillsPage.naviagteReveiableExportBiller(Log);
	            Pages.BillerReceivablesExportedbillsPage.searchExportedBillsUsingBillNUmber(testdatamap,Log);
