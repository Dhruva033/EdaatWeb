/**
*
* Test Script Name                   : AdminSettingsAddInvoiceTempplateErrorMsg 
* TestData Sheet Name                : AdminAddInvoiceTemplateErrMsg
* Objective                          : Verify to add invoice template error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminSettingsAddInvoiceTempplateErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminAddInvoiceTemplateErrMsg";  
	...
	public AdminSettingsAddInvoiceTempplateErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSettingsPage.VerifyAddInvoiceTemplateErrorMsg(TemplateArabic,TemplateEnglish,InvoiceType,ExpectedResult);
