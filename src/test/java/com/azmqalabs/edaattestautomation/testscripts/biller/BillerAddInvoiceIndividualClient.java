/**
* Test Script Name  				 : BillerAddInvoiceIndividualClient.
* Test Data SheetName				 : BillerAddInvoiceIndividualClt
* Objective     					 : To Verify Create Invoice for Individual client Functionality.
* Version      						 : 1.0
* Author       						 : Kathirvelu M
* Created Date 			      		 : 23/05/2023
* Last Updated on					 : N/A
* Updated By   			 			 : Basavaraj Mudnur
* Pre-Conditions					 : 1)Biller Login Credentials 2)Individual client should be present.
* Epic Details						 : N/A
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerIndividualClientPage.CreateIndividualClientInvoice(testdatamap, Log);
