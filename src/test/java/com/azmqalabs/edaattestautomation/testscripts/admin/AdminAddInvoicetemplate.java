/**
*
* Test Script Name                   : AdminAddInvoicetemplate
* TestData Sheet Name                : AdminAddInvoicesTemplates
* Objective                          : Verify to add Recurring Invoice template
* Version                            : 1.0
* Author                             : Kathirvelu M
...
* Pre-Conditions                     : 1)Admin Logged in with valid Credentials. 
                                       2) Invoice details should be present.
* Epic Details                       : N/A
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsPage.AddInvoicetemplate(TemplateArabic,TemplateEnglish,InvoiceType,Log);
...
//				this.driver=driverEvent;
				...
				//Log.QAMachineInfo();//Log.QAMachineInfo();
		    }
		// AFTER CLASS
	    @AfterClass
