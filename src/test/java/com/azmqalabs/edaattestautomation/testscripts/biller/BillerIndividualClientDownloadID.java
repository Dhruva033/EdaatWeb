/**
* Test Script Name                      : BillerIndividualClientDownloadID.
* Test Data Sheet Name					: BillerDownload
* Objective                             : Verify Download ID Image Functionality.
* Version                               : 1.0
* Author                                : Kathirvelu M
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerIndividualClientPage.Download(testdatamap, Log);
		    ...
		    public void beforeClass() throws Exception {
		        ...
		        extent=ExtentManager.CreateExtentReportExtent(browserFromXML);
		         className=this.getClass().getSimpleName();
		  	  	test=ExtentManager.CreateExtentReportTest(extent,className,testdatamap.get("TestDescription").toString(), browserFromXML,TestScriptID);		  	  		  	  	// INITIALIZE DRIVER
