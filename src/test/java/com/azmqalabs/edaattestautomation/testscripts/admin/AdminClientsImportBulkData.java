...
public class AdminClientsImportBulkData {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminClientsImportBulkData";
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminClientsImportBulkData(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminClientsImportClientDataPage.VerifyImportClientData(testdatamap,Log);
