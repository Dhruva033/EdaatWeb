/**
*
* Test Script Name                   : AdminSettingsAddPriceListErrorMsg 
* TestData Sheet Name                : AdminAddPriceListErrMsg 
* Objective                          : Verify to add Price List error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminSettingsAddPriceListErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminAddPriceListErrMsg";  
	...
	public AdminSettingsAddPriceListErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSettingsPricingListPage.VerifyAddPriceListErrorMsg(testdatamap,Log);
