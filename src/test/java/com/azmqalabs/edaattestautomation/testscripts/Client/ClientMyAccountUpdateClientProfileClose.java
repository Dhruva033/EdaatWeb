/**
*
* Test Script Name                      : ClientMyAccountUpdateClientProfileClose.
* Objective                             : Verify to update client Profile & Close under My account module.
* Testdata Sheet Name                   : UpdateClientProfileClose.
* Version                               : 1.0
...
public class ClientMyAccountUpdateClientProfileClose {
	
	// DECLARATION SECTION
	  static String TestDataTab="UpdateClientProfileClose";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientMyAccountUpdateClientProfileClose(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.ClientMyAccountPage.UpdateClientProfileClose(testdatamap, Log);
