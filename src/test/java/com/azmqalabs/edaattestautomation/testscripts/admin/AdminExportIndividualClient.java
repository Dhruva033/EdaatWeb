/**
*
* Test Script Name                   : AdminExportIndividualClient.
* TestData Sheet Name                : AdminExportIndividualClient
* Objective                          : Verify Exported to Excel link is clickable.
* Version                            : 1.0
* Author                             : Kathirvelu M
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminLoginPage.LoginToApplication(testdatamap,Log);
	        	 ...
	        	 Pages.AdminIndividualClientPage.Export(Log);
