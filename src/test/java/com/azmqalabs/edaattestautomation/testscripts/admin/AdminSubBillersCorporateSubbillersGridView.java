/**
*
* Test Script Name                   : AdminSubBillersCorporateSubbillersGridView 
* Test data sheet Name               : AdminSubBillerCorporateGridView
* Objective                          : Verify Grid view details under subbiller module.
* Version                            : 1.0
...
public class AdminSubBillersCorporateSubbillersGridView {

	// DECLARATION SECTION
	static String TestDataTab="AdminSubBillerCorporateGridView";  
	...
	public AdminSubBillersCorporateSubbillersGridView(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSubbillerPage.CorporateSubBillersGridView(EdaatOR.Admin_CorpSubBillerlnk,EdaatOR.Admin_CorpSubBillerGrid,Log);
