/**
*
* Test Script Name                   : BillerReportClientAccountStatementErrorMsg
* Test Data Sheet                    : BillerReportClientAccountstmUI
* Objective                          : Verify to Generate client account Statement report Functionality.
* Version                            : 1.0
...
public class BillerReportClientAccountStatementErrorMsg{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReportClientAccountstmUI";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReportClientAccountStatementErrorMsg(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            //Log.ReportEvent("INFO", "Step3 : Verify Generate Client account statement is Successful");
	        	Pages.BillerReportsReceivablesReportPage.ClientAccountStatementErrorMsgValidation(testdatamap);
