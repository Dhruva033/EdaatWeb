/**
* Test Script Name                      : ClientReportsClientAccountStatement
* Test Data Sheet Name                  : ClientReportstAccountStatement
* Objective                             : Verify the exported report for the selected Biller under Client Account Statements
* Version                               : 1.0
* Author                                : Basavaraj Mudnur
* Created Date                          : 
* Last Updated on                       : N/A
* Updated By                            :
* Pre-Conditions                        : Valid  Client Login credentials. 
* Epic Details                          : N/A
...
public class ClientReportsClientAccountStatement {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientReportstAccountStatement";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientReportsClientAccountStatement(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.ClientReportsClientAccountStatementPage.navigateToClientAccountStatement(Log);
	        	
	        	Pages.ClientReportsClientAccountStatementPage.VerifyAccountstatement(testdatamap,Log);
