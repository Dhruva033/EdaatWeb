/**
* Test Script Name                   : BillerReceivableReportforSuperBillerClientAccountStatementReport
...
public class BillerReceivableReportforSuperBillerClientAccountStatementReport{
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivableReportforSuperBillerClientAccountStatementReport(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReportReceivableReportforSuperBillerPage.VerifyClientAccountStatementReport(testdatamap, Log);
