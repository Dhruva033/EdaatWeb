/**
*
* Test Script Name                      : BillerReceivablesReportsCustomRecReportExportToExcel.
* Test Data Sheet                       : BillerCtmRecReportExportToExcel.
* Objective                             : Verify that when click on export to Excel the Excel arrives in to email.
* Version                               : 1.0
...
public class BillerReceivablesReportsCustomRecReportExportToExcel {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerCtmRecReportExportToExcel";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesReportsCustomRecReportExportToExcel(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            Pages.BillerReportsCustomReconciliationReportPage.validateExportToExcelFunctionality(testdatamap,Log);	            
