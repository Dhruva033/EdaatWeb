/**
* Test Script Name                      : BillerSubbillerCorporateSubSearch
* Test Data SheetName					: BillerCorporateSubAddSearch
* Objective                             : Verify corporate subbiller search under subbiller
* Version                               : 1.0
* Author                                : Kathirvelu M
...
public class BillerSubbillerCorporateSubSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerCorporateSubAddSearch";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSubbillerCorporateSubSearch(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", className+" Execution Started");
	           	...
	           	Pages.BillerSubbillerPage.CorporateSubBillerSearch(testdatamap, Log);
