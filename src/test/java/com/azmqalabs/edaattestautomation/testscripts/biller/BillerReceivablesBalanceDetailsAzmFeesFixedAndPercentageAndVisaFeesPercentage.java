/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndVisaFeesPercentage
* Test Data Sheet                    : BillerRecAzmFeesFixedPerVisaPer
* Objective                          : Verify the fees deduction correctly in Balance details page when AZM Fees [ Fixed & Percentage] and Visa Fees[  Percentage].
* Version                            : 1.0
* Author                             : Arun Kumar M AS
...
public class BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndVisaFeesPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerRecAzmFeesFixedPerVisaPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndVisaFeesPercentage(Map<Object, Object> testdatamap){
