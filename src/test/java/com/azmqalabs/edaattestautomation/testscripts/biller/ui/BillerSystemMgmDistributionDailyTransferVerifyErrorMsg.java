/**
*
* Test Script Name                   : BillerSystemMgmDistributionDailyTransferVerifyErrorMsg
* Test Data Sheet                    : BillerSysMgmDistDailyTransfer.
* Objective                          : Verify Daily Transfer Requests Error Message Under System Management Module
* Version                            : 1.0
...
public class BillerSystemMgmDistributionDailyTransferVerifyErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSysMgmDistDailyTransfer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSystemMgmDistributionDailyTransferVerifyErrorMsg(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step4 : Verify Daily transfer requests is Successful");
	        	Pages.BillerSystemMangementPage.VerifyDailyTransferErrorMsg(testdatamap);
