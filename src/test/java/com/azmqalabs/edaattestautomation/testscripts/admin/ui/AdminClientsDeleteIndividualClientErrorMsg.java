/**
*
* Test Script Name                   : AdminClientsDeleteIndividualClientErrorMsg 
* TestData Sheet Name                : AdminDeleteIndividualClientEr 
* Objective                          : Verify  delete Individual Client error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminClientsDeleteIndividualClientErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminDeleteIndividualClientEr";  
	...
	public AdminClientsDeleteIndividualClientErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Log.ReportEvent("INFO", "Step2 : Verify Biller Login is Sucessful");
			Pages.AdminLoginPage.LoginToApplication(testdatamap,Log);

			Log.ReportEvent("INFO", "Step3 : Verify Error message in delete Individual Client is Sucessful");
			Pages.AdminIndividualClientPage.VerifyDeleteIndClietErrorMsg(ExpectedResult);

			Log.ReportEvent("INFO", "Step4 : Logout  Sucessful");
