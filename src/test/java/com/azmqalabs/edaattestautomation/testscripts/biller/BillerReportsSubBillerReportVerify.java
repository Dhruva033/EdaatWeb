/**
*
* Test Script Name                   : BillerReportsSubBillerReportVerify
* TestData Sheet                     : BillerReportSubBillerReport
* Objective                          : Verify Sub Billers Report.
* Version                            : 1.0
* Author                             : Kathirvelu M
...
* Pre-Conditions                     : 1)Biller logged in with valid credentials
                                       2)Sub Biller should be present.
* Epic Details                       : N/A
...
public class BillerReportsSubBillerReportVerify{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReportSubBillerReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReportsSubBillerReportVerify(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReportsReceivablesReportPage.SubBillerReport(testdatamap, Log);
