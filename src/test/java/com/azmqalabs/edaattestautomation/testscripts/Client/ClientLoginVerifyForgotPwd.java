...
public class ClientLoginVerifyForgotPwd {
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientLoginVerifyForgotPwd(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.ClientLoginPage.VerifyForgotPassword(testdatamap,Log);
