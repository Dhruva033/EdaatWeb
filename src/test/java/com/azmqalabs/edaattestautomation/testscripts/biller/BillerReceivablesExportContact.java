/**
*
* Test Script Name                      : BillerReceivablesExportContact.
* Test Data Sheet                       : BillerReceivableExportContact.
* Objective                             : Verify the Exported contract and Print invoice details under Receivables module.
* Version                               : 1.0
...
public class BillerReceivablesExportContact {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceivableExportContact";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportContact(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.verifyExportContact(testdatamap, Log);	        	
