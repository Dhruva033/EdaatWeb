/**
*
* Test Script Name                   : AdminReceivablesInvoiceDetailsBtn
...
public class AdminReceivablesInvoiceDetailsBtn {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminViewInvoiceDetailsBtn";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReceivablesInvoiceDetailsBtn(Map<Object, Object> testdatamap){
	 ...
	 // TEST METHOD
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReceivablesBalancePage.verifyViewInvoiceBtn(testdatamap,Log);
