 /**
*
* Test Script Name                   : AdminReceivablesExportBills
* Test data sheet Name               : AdminReceivableExportBills
* Objective                          : 1.Verfiy create and export one time invoice  under Receivables Module.
                                       2.Verfiy bills list and bill status  under Receivables Module.
                                       3.Veirfy Export to excel link is clickable  under Receivables Module.
                                       4.Verify Bills cancellation button for exported bills under Receivables Module.
                                       5.Verify Confirm payed outside system button for exported bills  under Receivables Module.
                                       6.Verify View details button for the invoices  under Receivables Module.
* Version                            : 1.0
	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReceivablesExportedbillsPage.createExportInvoiceData(testdatamap,Log);
		...
		// BEFORE CLASS METHOD - BROWSER IITIALIZATION
		   @BeforeClass
