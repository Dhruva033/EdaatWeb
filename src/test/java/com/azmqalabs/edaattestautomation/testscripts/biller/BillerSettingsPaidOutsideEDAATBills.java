/**
* Test Script Name  				 : BillerSettingsPaidOutsideEDAATBills.
* TestDataSheetName					 : BillerSettingspaidUpload
...
public class BillerSettingsPaidOutsideEDAATBills {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSettingspaidUpload";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsPaidOutsideEDAATBills(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsPaidOutsideEDAATBillsPage.uploadBulkData(testdatamap, Log);
