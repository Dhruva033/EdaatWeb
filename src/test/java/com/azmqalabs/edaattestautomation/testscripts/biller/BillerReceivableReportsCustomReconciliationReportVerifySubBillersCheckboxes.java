/**
* Test Script Name                      : BillerReceivableReportsCustomReconciliationReportVerifySubBillersCheckboxes.
* Test Data SheetName					: CsmReconciliationRptSubBlrCheck
* Objective                             : Verify that the sub billers checkboxes hide if the biller didn't have sub billers.
* Version                               : 1.0
* Author                                : Kalpana I R
...
public class BillerReceivableReportsCustomReconciliationReportVerifySubBillersCheckboxes {
	
	// DECLARATION SECTION
	  static String TestDataTab="CsmReconciliationRptSubBlrCheck";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivableReportsCustomReconciliationReportVerifySubBillersCheckboxes(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReportsCustomReconciliationReportPage.VerifySubBillerCheckBoxesInCustomReconciliationReport(Log);
