/**
*
* Test Script Name                   : AdminSettingsPaidOutsideEdaatBillsErrorMsg 
* TestData Sheet Name                : AdminPaidOutsideEdaatBillErrMsg 
* Objective                          : Verify to Paid Outside Edaat Bills error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminSettingsPaidOutsideEdaatBillsErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminPaidOutsideEdaatBillErrMsg";  
	...
	public AdminSettingsPaidOutsideEdaatBillsErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Log.ReportEvent("INFO", "Step3 : Verify Error message in term Management page  is Sucessful");
			Pages.AdminSettingsPage.VerifyPaidOutsideEdaatBillsErrorMsg(testdatamap);
