/**
*
* Test Script Name                   : AdminViewInvoiceCorporateClient
* TestData Sheet Name                : AdminViewInvoiceCorporateClint
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminCorporatePage.ViewCorporateClientInvoice(testdatamap,Log);
