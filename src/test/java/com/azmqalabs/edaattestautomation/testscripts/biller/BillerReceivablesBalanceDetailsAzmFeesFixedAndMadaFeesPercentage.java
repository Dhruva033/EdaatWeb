/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesFixedAndMadaFeesPercentage
* Test Data Sheet                    : BillerRecAzmFeesFixedMadaPer
* Objective                          : Verify the fees deduction correctly  inBalance details page when AZM Fees [ Fixed ] and MADA Fees[Percentage].
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesFixedAndMadaFeesPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerRecAzmFeesFixedMadaPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedAndMadaFeesPercentage(Map<Object, Object> testdatamap){
