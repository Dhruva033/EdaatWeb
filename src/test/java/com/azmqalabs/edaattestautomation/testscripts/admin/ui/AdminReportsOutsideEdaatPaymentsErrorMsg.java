/**
*
* Test Script Name                   : AdminReportsOutsideEdaatPaymentsErrorMsg 
* TestData Sheet Name                : AdminiOutsideEdaatPymntErrMsg
* Objective                          : Verify Outside Edaat Payments report error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminReportsOutsideEdaatPaymentsErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminiOutsideEdaatPymntErrMsg";  
	...
	public AdminReportsOutsideEdaatPaymentsErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminReportsAdminReportsPage.VerifyOutsideEdaatPaymentsReportErrorMsg(testdatamap,Log);
