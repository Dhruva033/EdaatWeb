/**
*
* Test Script Name                   : BillersystemmanagementcheckerRejectActivation
* TestDataSheet                      : BillerSystemMgmtcheckerReject
...
public class BillersystemmanagementcheckerRejectActivation {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSystemMgmtcheckerReject";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillersystemmanagementcheckerRejectActivation(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSystemMangementPage.RejectActivation(testdatamap,Log);
