...
public class BillerReceivablesBalanceDetailsAzmFeesFixedPercentageAndMasterFeesFixedPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BilerAzmFsFixPerAndMasterFixPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedPercentageAndMasterFeesFixedPercentage(Map<Object, Object> testdatamap){
