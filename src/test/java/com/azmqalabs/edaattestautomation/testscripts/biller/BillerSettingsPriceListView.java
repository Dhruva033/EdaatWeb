/**
*
* Test Script Name                      : BillerSettingsPriceListView.
* TestDataSheet                         : BillerPriceView
* Objective                             : Verify  view Price details button
* Version                               : 1.0
...
public class BillerSettingsPriceListView {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerPriceView";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsPriceListView(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingPricelistPage.VerifyViewPriceButton(testdatamap,Log);
