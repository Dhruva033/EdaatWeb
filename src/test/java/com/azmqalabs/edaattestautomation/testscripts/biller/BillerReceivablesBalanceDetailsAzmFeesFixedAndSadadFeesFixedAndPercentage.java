...
public class BillerReceivablesBalanceDetailsAzmFeesFixedAndSadadFeesFixedAndPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAzmFeesFixAndSadadFixPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedAndSadadFeesFixedAndPercentage(Map<Object, Object> testdatamap){
