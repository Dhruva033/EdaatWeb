/**
*
* Test Script Name                   : ClientPayablesIncomingBillsVerifyNewlyAddedPaymentMethodColumn
* Test Data Sheet Name				 : ClientIncomingBillsNewPmtColumn
* Objective                          : Verify Add new columns in incoming bills page for the payment method 
* Version                            : 1.0
...
public class ClientPayablesIncomingBillsVerifyNewlyAddedPaymentMethodColumn {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientIncomingBillsNewPmtColumn";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientPayablesIncomingBillsVerifyNewlyAddedPaymentMethodColumn(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	// LOGIN WITH COMMON USER ID
	        	Pages.ClientPayablesIncomingBillsPage.VerifyNewAddedPaymentMethodColumn(Log);
