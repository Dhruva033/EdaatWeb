/**
*
* Test Script Name                      : BillerReceivablesExportContactPaymentMethodDropdownVerify
...
public class BillerReceivablesExportContactPaymentMethodDropdownVerify {
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportContactPaymentMethodDropdownVerify(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.verifyPaymentMethodInExportContactSearch(testdatamap, Log);	        	
