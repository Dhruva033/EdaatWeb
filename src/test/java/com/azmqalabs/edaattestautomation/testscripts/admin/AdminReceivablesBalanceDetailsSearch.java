/**
*
* Test Script Name                   : AdminReceivablesBalanceDetailsSearch 
* Test data sheet Name               : AdminRCVBalanceDetailsSearch
* Objective                          : Verify Search functionality under Receivables module.
* Version                            : 1.0
...
public class AdminReceivablesBalanceDetailsSearch {

	// DECLARATION SECTION
	static String TestDataTab="AdminRCVBalanceDetailsSearch";  
	...
	public AdminReceivablesBalanceDetailsSearch(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminReceivablesBalancePage.BalanceSearch(testdatamap,Log);
