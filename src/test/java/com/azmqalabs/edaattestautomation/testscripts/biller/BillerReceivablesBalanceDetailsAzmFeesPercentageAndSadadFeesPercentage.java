/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesPercentageAndSadadFeesPercentage
* Test Data Sheet                    : BillerRecAzmFeesPerSadadPer
* Objective                          : Verify the fees deduction correctly  in Balance details page when AZM Fees [Percentage] and sadad Fees [Percentage].
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesPercentageAndSadadFeesPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerRecAzmFeesPerMadaPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesPercentageAndSadadFeesPercentage(Map<Object, Object> testdatamap){
