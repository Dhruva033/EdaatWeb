/**
*
* Test Script Name                   : BillerSettingsTermsMangementSearch
* TestDataSheet                      : BillerSettingSearchTerms
...
public class BillerSettingsTermsMangementSearch{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSettingSearchTerms";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsTermsMangementSearch(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingTermsManagementPage.VerifySearchTerm(testdatamap, Log);
