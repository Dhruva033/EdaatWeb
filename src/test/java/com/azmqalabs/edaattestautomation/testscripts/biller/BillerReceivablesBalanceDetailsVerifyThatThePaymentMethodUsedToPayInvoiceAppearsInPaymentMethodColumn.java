/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsVerifyThatThePaymentMethodUsedToPayInvoiceAppearsInPaymentMethodColumn.
* Test Data Sheet                    : BillerReceBalanceDetailsPayment
* Objective                          : verify that the payment method used to pay invoice appears in payment method column under Receivables Balance details.
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsVerifyThatThePaymentMethodUsedToPayInvoiceAppearsInPaymentMethodColumn {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceBalanceDetailsPayment";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsVerifyThatThePaymentMethodUsedToPayInvoiceAppearsInPaymentMethodColumn(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesBalancePage.verifyThePaymentMethodInThePaymentMethodColumn(testdatamap,Log);
