 /**
* Test Script Name                   : AdminReceiReportsOverDueBills.
* TestData sheet Name                : AdminReceReportsOverDueBills.
* Objective                          : Verify to generate Over Due Bills under Receivables Reports.
* Version                            : 1.0
...
public class AdminReceiReportsOverDueBills {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReceReportsOverDueBills";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReceiReportsOverDueBills(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReportsReceivablesReportsPage.OverDueBills(testdatamap,Log);
