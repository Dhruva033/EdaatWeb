/**
*
* Test Script Name                      : BillerReceivablesReportsCustRecReportsSearchBtnClickable.
* Test Data Sheet                       : BillerCRReportSearchClickable.
* Objective                             : Verify that the search button in clickable.
* Version                               : 1.0
...
public class BillerReceivablesReportsCustRecReportsSearchBtnClickable {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerCRReportSearchClickable";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesReportsCustRecReportsSearchBtnClickable(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            Pages.BillerReportsCustomReconciliationReportPage.validateSearchButtonIsClickableFunctionality(testdatamap,Log);	            
