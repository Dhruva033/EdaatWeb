/**
* Test Script Name  				 : BillerReceivableReportsCustomReconciliationReportGroupPermission
* Test Data Sheet Name				 : BillerCustomReportGrpPermission
* Objective     					 : Verify that the Cutome reconciliation report appears in the  Group Permission
* Version      						 : 1.0
...
public class BillerReceivableReportsCustomReconciliationReportGroupPermission {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerCustomReportGrpPermission";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivableReportsCustomReconciliationReportGroupPermission(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerUserGroupManagementPage.naviagteGroupManagement(Log);
	        	Pages.BillerUserGroupManagementPage.VerifyCustomReconciliationReportAppearsIntheGroupPermission(testdatamap,Log);
