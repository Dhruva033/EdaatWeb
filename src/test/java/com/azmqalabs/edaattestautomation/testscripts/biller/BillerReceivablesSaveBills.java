/**
*
* Test Script Name                      : BillerReceivablesSaveBills.
* Test Data Sheet                       : BillerReceivableSaveBills.
...
public class BillerReceivablesSaveBills {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceivableSaveBills";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesSaveBills(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.naviagteReveiableExportBiller(Log);     	        		        	
	           	Pages.BillerReceivablesExportedbillsPage.createSaveInvoiceData(testdatamap,Log);	           	       	
