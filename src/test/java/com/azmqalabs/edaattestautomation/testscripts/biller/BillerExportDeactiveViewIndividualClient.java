/**
* Test Script Name                    : BillerExportDeactiveViewIndividualClient.
* Test Data Sheet Name				  : BillerExportDeactiveViewIndivid.
* Objective                           : 1)Verify Grid view details under Individual Client 2)Verify Activate/Deactivate for Individual Clients 3) Verify Exported to Excel link is clickable in Individual client.
* Version                             : 1.0
* Author                              : Kathirvelu M
* Created Date                        : 15/05/2023 to 19/05/2023
* Last Updated on                     : N/A
...
public class BillerExportDeactiveViewIndividualClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerExportDeactiveViewIndivid";  
	 ...
	 String className="";
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerExportDeactiveViewIndividualClient(Map<Object, Object> testdatamap){
	    	this.testdatamap=testdatamap;
	        this.TestScriptID=testdatamap.get("TestScriptID").toString();
	        this.sBrowserTestData=testdatamap.get("Browser").toString();
	        this.Action=testdatamap.get("Action").toString();
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerLoginPage.LoginToApplication(Log);
	        	Pages.BillerIndividualClientPage.Action(Action, Log);
