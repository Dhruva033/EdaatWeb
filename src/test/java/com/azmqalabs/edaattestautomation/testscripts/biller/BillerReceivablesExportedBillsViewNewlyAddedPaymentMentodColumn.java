/**
*
* Test Script Name                      : BillerReceivablesExportedBillsViewNewAddedPaymentMentodColumn.
* Test Data Sheet                       : BillerExportBillsViewNewGridClm.
* Objective                             : Verify Add new columns in Exported Bills page for the payment method. 
* Version                               : 1.0
...
public class BillerReceivablesExportedBillsViewNewlyAddedPaymentMentodColumn {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerExportBillsViewNewGridClm";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportedBillsViewNewlyAddedPaymentMentodColumn(Map<Object, Object> testdatamap){
