...
* Objective                             : Verify to Activate the account through email.
* Version                               : 1.0
...
public class ClientPayablesInsBillsContractClickable {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientPayableInstallBillClick";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientPayablesInsBillsContractClickable(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.ClientPayablesInstallmentsBillsPage.InstallmentBillSContractclick(testdatamap, Log);
