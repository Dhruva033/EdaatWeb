...
* Objective                             : verify that the available payment method appears when click on view button of an invoice
* Version                               : 1.0
* Author                                : Kalpana I R
...
public class BillerReceivablesExportBillsPaymentMethodLogoVerification {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerExportBillsPayment";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportBillsPaymentMethodLogoVerification(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.verifyPaymentMethodLogoInBillNumber(testdatamap, Log);	        	
