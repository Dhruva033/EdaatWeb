/**
* Test Script Name  				 : AdminSettingsContentMgmUploadBulkData
* Testdata Sheet Name                : AdminContentMgmUploadBulkdata
...
public class AdminSettingsContentMgmUploadBulkData {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminContentMgmUploadBulkdata";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsContentMgmUploadBulkData(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsContentManagementPage.NavigatetoSettingsContentManagement(Log);
	        	
	        	Pages.AdminSettingsContentManagementPage.VerifyToUploadBulkData(testdatamap,Log);
