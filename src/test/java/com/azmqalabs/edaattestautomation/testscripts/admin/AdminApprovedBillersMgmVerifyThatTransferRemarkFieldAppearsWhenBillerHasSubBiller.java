/**
* Test Script Name                   : AdminApprovedBillersMgmVerifyThatTransferRemarkFieldAppearsWhenBillerHasSubBiller
* Objective                          : 1)Verify that the field appears when the biller has a sub-biller and chooses in the invoice issuing under System Management module
* Version                            : 1.0
* Author                             : Kathirvelu Mohan
* Created Date                       : 25/04/2024
* Last Updated on                    : N/A
* Updated By                         : Dhruva Kumar S
* Pre-Conditions                     : Valid Admin Login Credentials
* Epic Details                       : N/A
...
public class AdminApprovedBillersMgmVerifyThatTransferRemarkFieldAppearsWhenBillerHasSubBiller {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdmApprovedBillersMgmTransField";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminApprovedBillersMgmVerifyThatTransferRemarkFieldAppearsWhenBillerHasSubBiller(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMangement.navigateApprovedBillerManagement(testdatamap,Log);
	        	
	        	Pages.AdminSystemMangement.searchforapprbiller(testdatamap,Log);
	        	
	        	Pages.AdminApprovedBillerManagement.VerifyTransferRemarkFieldIsChecked(testdatamap,Log);
	        	
	        	Pages.AdminLoginPage.Logout(EdaatOR.Logout,Log);
	        	
	        	Pages.BillerLoginPage.LoginToApplication(testdatamap.get("BillerUserName").toString(),testdatamap.get("BillerPassword").toString(),Log);
	        	
	        	Pages.BillerReceivablesExportedbillsPage.naviagteReveiableExportBiller(Log);
	        	
		        Pages.BillerReceivablesExportedbillsPage.VerifyTransferRemarkFieldAppearsAfterSelectingSubBiller(testdatamap, Log);
