...
public class ClientLoginChangeLang {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientLoginChangeLang";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientLoginChangeLang(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.InvokeApplicationPage.Chooseoptions2(Log);	
	        	
	        	// LOGIN WITH COMMON USER ID
	        	Pages.ClientLoginPage.ChangeLanguage(testdatamap,Log);       	
