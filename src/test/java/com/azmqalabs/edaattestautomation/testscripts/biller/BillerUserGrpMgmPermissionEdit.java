/**
*
* Test Script Name                   : BillerUserGrpMgmPermissionEdit
* TestDataSheet                      : BillerUserGroupMgmUpdatePermiss
* Objective                          : 1)Verify to view group permission
                                       2)Verify to edit group permission
* Version                            : 1.0
	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerUserGroupManagementPage.addGroup(testdatamap,Log);
	        	
	        	Pages.BillerUserGroupManagementPage.updateAndViewGroupPermission(testdatamap,Log);
