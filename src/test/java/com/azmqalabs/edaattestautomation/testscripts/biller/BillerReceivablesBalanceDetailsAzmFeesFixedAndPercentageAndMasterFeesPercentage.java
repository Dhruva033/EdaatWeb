/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndMasterFeesPercentage.
* Test Data Sheet                    : BillerReceAzmFixPerMasterPer
* Objective                          : Verify the fees deduction correctly in  Balance details page when AZM Fees [ Fixed & Percentage] and Master Fees[Percentage] under Receivables Balance details.
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndMasterFeesPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceAzmFixPerMasterPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndMasterFeesPercentage(Map<Object, Object> testdatamap){
