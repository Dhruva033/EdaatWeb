/**
*
* Test Script Name                      : BillerSettingsInvoicesTemplatesDelete.
* TestDataSheet                         : BillerInvoiceTemplateDelete
* Objective                             : Verify Biller delete Invoice button.
* Version                               : 1.0
	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsPage.verfiyDeleteInvoiceTemplate(testdatamap,Log);
