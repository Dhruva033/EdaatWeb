...
public class BillerReportsReceivablesReportPage extends BasePage {
	...
	public void VerifyIndividualClientsReport(Map<Object, Object> testdatamap, Log Log) throws Exception {
		try {
			...
			test.log(Status.PASS, "#FUNC-Delete User from userlist and IsDelete User check box" + driver.getTitle()
	...
	public void navigatetoclientAccountStatement() {
		try {
			...
			test.log(Status.PASS,
					"#FUNC-ClientAccountPage " + driver.getTitle() + " * ClientAccountReportPage PASS * ");
			this.takeScreenShot();
		} catch (Exception e) {
	...
	public void ClientAccountReports(Map<Object, Object> testdatamap, Log Log) {
		try {
			...
			test.log(Status.FAIL,
					"#FUNC-Generate Report and export" + driver.getTitle() + " * Generate Report and export FAIL * ");
			this.takeScreenShot();
		}
	}
	...
	public void navigatetoclientinvoicereport(Log Log) {
		try {
			...
			Thread.sleep(1000);
			test.log(Status.PASS,
					"#FUNC-ClientInvoiceReportPage " + driver.getTitle() + " * ClientInvoiceReportPage PASS * ");
			Log.ReportEvent("PASS", " Verify Navigate to Verify ClientInvoiceReport Generate is Suceessful");
			this.takeScreenShot();
		} catch (Exception e) {
			test.log(Status.FAIL,
					"#FUNC-ClientInvoiceReportPage" + driver.getTitle() + " * ClientInvoiceReportPage FAIL * ");
			this.takeScreenShot();
		}
...
//				Thread.sleep(1000);
			...
			Thread.sleep(1000);
			test.log(Status.PASS,
					"#FUNC-Generate Report and export " + driver.getTitle() + " * Generate Report and export PASS * ");
	...
	public void CorporateClientReport(Log Log) {
		...
		try {
			...
			driver.navigate().back();
			test.log(Status.PASS,
					"#FUNC-Corporate client report " + driver.getTitle() + " * Corporate client report FAIL * ");
			Log.ReportEvent("PASS", " Verify Generate Client account statement is Successful");
		}
	...
	public void SubBillerReport(Map<Object, Object> testdatamap, Log Log) {
		...
		try {
			...
			test.log(Status.FAIL, "#FUNC-Sub biller report " + driver.getTitle() + " * Sub biller report  FAIL * ");
			this.takeScreenShot();
		}
	}
	...
	public void VerifyOverdueBillsReport(Map<Object, Object> testdatamap, Log Log) {
		try {
			...
			Thread.sleep(1000);
			VerifyValue1(getText("//div[text()='" + testdatamap.get("ClientName").toString() + "']"),
					testdatamap.get("ClientName").toString());
			Thread.sleep(2000);
			switchBacktoParentwindow();
			test.log(Status.PASS, "#FUNC-Verify Overdue Bills Report " + driver.getTitle()
					+ " * Verify Overdue Bills Report is PASS * ");
			Log.ReportEvent("PASS", " Verify Overdue Bills Report is Suceessful is Suceessful");
			this.takeScreenShot();
		} catch (Exception e) {
			test.log(Status.FAIL, "#FUNC-Verify Overdue Bills Report " + driver.getTitle()
					+ " * Verify Overdue Bills Report is FAIL * ");
			this.takeScreenShot();
		}
	}
	...
	public void VerifySadadPaymentTransactionReport(Map<Object, Object> testdatamap, Log Log) {
		...
		try {
			...
			Thread.sleep(1000);
			switchBacktoParentwindow();
			test.log(Status.PASS, "#FUNC-Verify Sadad Payments Transactions Report " + driver.getTitle()
					+ " * Sadad Payments Transactions Report PASS * ");
			Log.ReportEvent("PASS", "Verify Sadad Payments Transaction Generate Report is Suceessful");
		} catch (Exception e) {
			test.log(Status.FAIL, "#FUNC-Verify Sadad Payments Transactions Report" + driver.getTitle()
					+ " * Sadad Payments Transactions Report FAIL * ");
			this.takeScreenShot();
		}
	}
	...
	public void ClientAccountStatementErrorMsgValidation(Map<Object, Object> testdatamap) {
		try {
			...
			if (ExistsCheck(EdaatOR.Biller_Reports_Receiv_ClientAccStm_ClientTypeError)) {
				VerifyValue1(getText(EdaatOR.Biller_Reports_Receiv_ClientAccStm_ClientTypeError),
						testdatamap.get("ExpectedResult").toString());
				test.log(Status.PASS, "#FUNC-This Field Is Required ErrorMessage Exists" + driver.getTitle()
						+ " * This Field Is Required ErrorMessage Exists * ");
			} else if (ExistsCheck(EdaatOR.Biller_Reports_Receiv_ClientAccStm_ClientError)) {
				VerifyValue1(getText(EdaatOR.Biller_Reports_Receiv_ClientAccStm_ClientError),
						testdatamap.get("ExpectedResult").toString());
				test.log(Status.PASS, "#FUNC-This Field Is Required ErrorMessage Exists" + driver.getTitle()
						+ " *This Field Is Required ErrorMessage Exists * ");
			} else if (ExistsCheck(EdaatOR.Biller_Reports_Receiv_ClientAccStm_FromDateError)) {
				VerifyValue1(getText(EdaatOR.Biller_Reports_Receiv_ClientAccStm_FromDateError),
						testdatamap.get("ExpectedResult").toString());
				test.log(Status.PASS, "#FUNC-This Field Is Required ErrorMessage Exists" + driver.getTitle()
						+ " *This Field Is Required ErrorMessage Exists * ");
			} else {
			...
			test.log(Status.FAIL, "#FUNC-Receivable Reports Client Account Stataement Fail" + driver.getTitle()
					+ " * Receivable Reports Client Account Stataement FAIL * ");
			this.takeScreenShot();
		}
	}
