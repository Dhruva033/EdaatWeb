/**
* Test Script Name  				 : BillerReceivableReportsSadadPaymentVerify
* Test Data Sheet Name				 : BillerReportsSadadPayment
* Objective     					 : Verify Sadad Payments Transactions Report under Reports module
* Version      						 : 1.0
...
public class BillerReceivableReportsSadadPaymentVerify {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReportsSadadPayment";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivableReportsSadadPaymentVerify(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReportsReceivablesReportPage.NavigatetoSadadPaymentsTransactionsReport(Log);
	        	Pages.BillerReportsReceivablesReportPage.VerifySadadPaymentTransactionReport(testdatamap, Log);
