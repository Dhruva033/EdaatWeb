/**
*
* Test Script Name                   : BillerSystemMgmIndividualClientAccountSettingButtonErrorMsg 
* Test data sheet Name               : BillerSysMgmIndSettingButton
* Objective                          : Verify Account Setting button [Suspended,Suspended Permanently] Error Message under system management module
* Version                            : 1.0
* Author                             : Kathirvelu Mohan
* Created Date                       : 23/05/2023
* Last Updated on                    : N/A
* Updated By                         : Obalanayak M S
* Pre-Conditions                     : 1)Valid Maker login credentials 
                                       2)Individual Client details should be present
* Epic Details                       : N/A
...
public class BillerSystemMgmIndividualClientAccountSettingButtonErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="BillerSysMgmIndSettingButton";  
	...
	public BillerSystemMgmIndividualClientAccountSettingButtonErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Log.ReportEvent("INFO", "Step2 : Verify Client Registration is Suceessful");
			Pages.ClientSignUpPage.ClientRegister(testdatamap,Log);
			
			Log.ReportEvent("INFO", "Step2 : Verify Admin Login is Suceessful");
			Pages.BillerLoginPage.clickOnBillerLogin();
			Pages.BillerLoginPage.LoginToApplication(testdatamap,Log);
			
			Log.ReportEvent("INFO", "Step3 : Verify to navigate Individual Client management is Suceessful");
			Pages.BillerSystemMangementPage.NavigateIndividualClientManagement();

			Log.ReportEvent("INFO", "Step4 : Verify Account Setting button Error Message is Suceessful");
			Pages.BillerSystemMangementPage.VerifyAccountSettingButtonErrorMsg(testdatamap);
