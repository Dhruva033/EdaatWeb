/**
*
* Test Script Name                      : BillerReceivablesIDPrintBills.
* Test Data Sheet                       : BillerReceivableIDPrintBills.
* Objective                             : Verify to print invoice details under receivables module.
* Version                               : 1.0
...
public class BillerReceivablesIDPrintBills {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceivableIDPrintBills";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesIDPrintBills(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.naviagteReveiableExportBiller(Log);	        	
	         	Pages.BillerReceivablesExportedbillsPage.verifyInvoiceIDandPrint(testdatamap, Log);
