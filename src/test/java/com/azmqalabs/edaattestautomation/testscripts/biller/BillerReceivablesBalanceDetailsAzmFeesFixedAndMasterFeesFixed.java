/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesFixedAndMasterFeesFixed.
* Test Data Sheet                    : BillerReceAzmFeesFixMasterFix
* Objective                          : Verify the fees deduction correctly in   Balance details page when AZM Fees [ Fixed ] and Master Fees[ Fixed ] under Receivables Balance details.
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesFixedAndMasterFeesFixed {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceAzmFeesFixMasterFix";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedAndMasterFeesFixed(Map<Object, Object> testdatamap){
