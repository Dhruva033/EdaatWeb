/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndSadadFeesFixedAndPercentage
* Test Data Sheet                    : BillerReceAzmSadadFeesFixedPer
* Objective                          : Verify the fees deduction correctly in Balance details page when AZM Fees [ Fixed & Percentage] and Sadad Fees[ Fixed & Percentage].
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndSadadFeesFixedAndPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceAzmSadadFeesFixedPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndSadadFeesFixedAndPercentage(Map<Object, Object> testdatamap){
