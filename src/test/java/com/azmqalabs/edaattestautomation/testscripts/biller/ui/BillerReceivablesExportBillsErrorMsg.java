/**
*
* Test Script Name                      : BillerReceivablesExportBills.
* Test Data Sheet                       : BillerReceivableExportBills.
* Objective                             : Verify create and Export one time invoice under Receivables Module.
* Version                               : 1.0
...
public class BillerReceivablesExportBillsErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceInvoiceUI";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportBillsErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.Onetimeerrorvalidation(testdatamap);
