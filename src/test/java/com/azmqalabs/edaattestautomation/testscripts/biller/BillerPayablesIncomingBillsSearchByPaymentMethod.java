/**
*
* Test Script Name                   : BillerPayablesIncomingBillsSearchByPaymentMethod
* Test Data Sheet                    : BillerIncomingBillSearchPayment
* Objective                          : Verify that they can search by payment method
* Version                            : 1.0
...
public class BillerPayablesIncomingBillsSearchByPaymentMethod{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerIncomingBillSearchPayment";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerPayablesIncomingBillsSearchByPaymentMethod(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerPayablesPage.navigate(Log);
	        	Pages.BillerPayablesPage.searchPaymentMethod(testdatamap, Log);
