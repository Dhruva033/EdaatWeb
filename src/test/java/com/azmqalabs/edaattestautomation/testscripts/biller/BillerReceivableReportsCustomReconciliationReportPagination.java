/**
* Test Script Name  				 : BillerReceivableReportsCustomReconciliationReportPagination
* Test Data Sheet Name				 : BillerCustomReconcillationPage
* Objective     					 : Verify the pagination in the report
* Version      						 : 1.0
...
public class BillerReceivableReportsCustomReconciliationReportPagination {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerCustomReconcillationPage";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivableReportsCustomReconciliationReportPagination(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReportsCustomReconciliationReportPage.navigateToCustomReconciliationReportPage(Log);
	        	Pages.BillerReportsCustomReconciliationReportPage.verifyPaginationInTheReport(testdatamap, Log);
