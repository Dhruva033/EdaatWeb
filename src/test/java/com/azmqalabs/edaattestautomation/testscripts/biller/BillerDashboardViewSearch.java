/**
*
* Test Script Name                   : BillerDashboardViewSearch.
* Test Data Sheet                    : BillerDashboardSearch.
* Objective                          : Verify the search and view Functionality under Dashboard module.
* Version                            : 1.0
* Author                             : ArunKumar MS
...
public class BillerDashboardViewSearch{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerDashboardSearch";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerDashboardViewSearch(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", className+" Execution Started");	        
	           	...
	           	Pages.BillerDashboardPages.TrackerBillerSearch(testdatamap, Log);
