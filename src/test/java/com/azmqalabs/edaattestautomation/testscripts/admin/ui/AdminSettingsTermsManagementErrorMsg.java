/**
*
* Test Script Name                   : AdminSettingsTermsManagementErrorMsg 
* TestData Sheet Name                : AdminTermMgmErrMsg 
* Objective                          : Verify to term management error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminSettingsTermsManagementErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminTermMgmErrMsg";  
	...
	public AdminSettingsTermsManagementErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSettingTermsManagementPage.VerifyAddTermErrorMsg(testdatamap,Log);
