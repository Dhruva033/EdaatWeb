/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesFixedVisaFeesFixedAndPercentage.
* Test Data Sheet                    : BillerReceivablesMadaFeesPer
* Objective                          : Verify the fees deduction correctly in   Balance details page when AZM Fees [ Fixed] and Visa Fees[ Fixed & Percentage]
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesFixedVisaFeesFixedAndPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAzmFeesFixedBalanceDetail";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedVisaFeesFixedAndPercentage(Map<Object, Object> testdatamap){
