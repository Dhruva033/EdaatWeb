...
public class BillerReceivablesBalanceDetailsAzmFeesPercentageAndSadadFeesFixedPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAzmFeesPerAndSadadFixPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesPercentageAndSadadFeesFixedPercentage(Map<Object, Object> testdatamap){
