/**
*
* Test Script Name                      : BillerReceivablesVerifyPaymentMethodsEditableInInvoiceDetailsPage.
* Test Data Sheet                       : BillerExportedBillsPMEditable.
...
public class BillerReceivablesVerifyPaymentMethodsEditableInInvoiceDetailsPage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerExportedBillsPMEditable";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesVerifyPaymentMethodsEditableInInvoiceDetailsPage(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.naviagteReveiableExportBiller(Log);     	        		        	
	           	Pages.BillerReceivablesExportedbillsPage.verifyInvoiceDetailsPaymentMethodsEditable(Log);	           	       	
