/**
*
* Test Script Name                      : ClientSignUpErrorMsg.
* Test Data Sheet Name                  : ClientSignUpErrMsg
* Objective                             : Verify error messages in client registration page.
* Version                               : 1.0
* Author                                : Kathirvelu M
...
public class ClientSignUpErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientSignUpErrMsg";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientSignUpErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step2 : Verify User Able to Register or Sign Up  and Verify to Activate the account through email Successfully");
	        	Pages.ClientSignUpPage.ClientRegistrationErrormessageValidation(testdatamap);
