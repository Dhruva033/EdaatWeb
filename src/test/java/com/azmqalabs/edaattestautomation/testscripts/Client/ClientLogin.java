/**
* Test Script Name  				 : ClientLogin.
* Test Data Sheet Name  		     : ClientLogin.
* Objective     					 : To Verify to login with valid Client account credentials.
* Version      						 : 1.0
* Author       						 : Basavaraj Mudnur
* Created Date 			      		 : 
* Last Updated on					 : N/A
* Updated By   			 			 : Basavaraj Mudnur
* Pre-Conditions					 : Client valid Username and password
* Epic Details						 : N/A
...
public class ClientLogin {
	...
	// DECLARATION SECTION
	  static String TestDataTab="ClientLogin";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientLogin(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.ClientLoginPage.LoginToApplication(testdatamap,Log);
	           	...
	           	Pages.ClientLoginPage.ExistsCheckElement(Log);
