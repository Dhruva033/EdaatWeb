/**
*
* Test Script Name                   : AdminSettingsAddProductErrorMsg 
* TestData Sheet Name                : AdminAddProductErrMsg
* Objective                          : Verify to add Product error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminSettingsAddProductErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminAddProductErrMsg";  
	...
	public AdminSettingsAddProductErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSettingsPage.VerifyAddProductErrorMsg(testdatamap,Log);
