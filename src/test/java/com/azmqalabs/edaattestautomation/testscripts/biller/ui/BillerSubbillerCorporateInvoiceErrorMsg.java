...
public class BillerSubbillerCorporateInvoiceErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerCorporateSubinvoiceUi";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSubbillerCorporateInvoiceErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSubbillerPage.addCorporateSubBillerwithInvoiceUi(testdatamap);
