/**
*
* Test Script Name                   : AdminPayablesIncomingBillsSearch
* Test Data Sheet                    : AdminPayablesIncomingBillSearch
...
public class AdminPayablesIncomingBillsSearch{
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminPayablesIncomingBillSearch";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminPayablesIncomingBillsSearch(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminPayablesIncomingBillsPage.IncomingBillsSearch(testdatamap,Log);
