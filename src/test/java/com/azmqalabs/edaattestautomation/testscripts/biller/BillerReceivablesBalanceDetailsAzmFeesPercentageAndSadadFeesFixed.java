/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesPercentageAndSadadFeesFixed
* Test Data Sheet                    : BillerRecAzmFeesPerSadadFixed
* Objective                          : Verify the fees deduction correctly  inBalance details page when AZM Fees [Percentage] and sadad Fees [Fixed].
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesPercentageAndSadadFeesFixed {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerRecAzmFeesPerSadadFixed";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesPercentageAndSadadFeesFixed(Map<Object, Object> testdatamap){
