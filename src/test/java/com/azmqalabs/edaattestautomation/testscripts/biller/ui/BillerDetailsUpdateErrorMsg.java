/**
* Test Script Name  				 : BillerDetailsUpdateErrorMsg.
*TestDataSheet                       : BillerSytMgmDetailsUpdateUI
* Objective     					 : Verify to update biller account Info.
* Version      						 : 1.0
* Author       						 : Kathirvelu Mohan
* Created Date 			      		 : 29/05/2023
* Last Updated on					 : N/A
* Updated By   			 			 : Obalanayak M S
* Pre-Conditions					 : Maker Login Credentials.  
* Epic Details						 : N/A
...
public class BillerDetailsUpdateErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSytMgmDetailsUpdateUI";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerDetailsUpdateErrorMsg(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Maker Login is Suceessfull");
	        	...
	        	Pages.BillerSystemMangementPage.UpdateBillerdetailsErrorMSGvalidation(testdatamap);
