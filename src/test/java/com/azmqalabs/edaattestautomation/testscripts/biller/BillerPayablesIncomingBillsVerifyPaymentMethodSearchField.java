/**
*
* Test Script Name                   : BillerPayablesIncomingBillsVerifyPaymentMethodSearchField
* Test Data Sheet                    : BillerPayablesPaymentMethod
...
public class BillerPayablesIncomingBillsVerifyPaymentMethodSearchField{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerPayablesPaymentMethod";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerPayablesIncomingBillsVerifyPaymentMethodSearchField(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerPayablesPage.verifyPaymentMethodSearchField(Log);
