/**
*
* Test Script Name                   : AdminSearchCorporateClient.
* TestData Sheet Name                : AdminCorporateSearch.
...
public class AdminSearchCorporateClient {
	...
	// DECLARATION SECTION
	  static String TestDataTab="AdminSearchCorporateClient";  
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminCorporatePage.AdminSearchCorporateclientall(CRNumber,CorporateName,Corporateno,Log);
