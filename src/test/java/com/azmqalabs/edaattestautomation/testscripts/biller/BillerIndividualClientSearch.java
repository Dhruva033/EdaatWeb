/**
* Test Script Name                      : BillerIndividualClientSearch.
* Test Data sheetName				 	: BillerAddIndividualClient.
* Objective                             : Verify Individual client Search functionality.
* Version                               : 1.0
* Author                                : Kathirvelu M
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerIndividualClientPage.BillerSearchIndividualclientall(FullName,NationalID,Refno, Log);
