/**
* Test Script Name  				 : BillerSettingsPaidOutsideEDAATBillsErrorMsg.
* TestDataSheetName					 : BillerSettingsPaidUploadUI
* Objective     					 : To Verify to upload Bulk data under  PaidOutsideEdaatBills
* Version      						 : 1.0
...
public class BillerSettingsPaidOutsideEDAATBillsErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSettingsPaidUploadUI";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsPaidOutsideEDAATBillsErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Navigate PaidOutsideEDAATBills Page is dispayed Suceessfull");
	        	Pages.BillerSettingsPaidOutsideEDAATBillsPage.navigatetoPaidOutsideBills(Log);
	        	
	        	Log.ReportEvent("INFO", "Step4 : Verify upload Bulk data Is Suceessfull");
	        	Pages.BillerSettingsPaidOutsideEDAATBillsPage.PaidOutsideEdaatErrorMessageValidation(testdatamap);
