/**
*
* Test Script Name                      : BillerSettingsAddPriceListErrorMsg.
* TestDataSheet                         : BillerAddPriceListUI
* Objective                             : Verify to add price list .
* Version                               : 1.0
...
public class BillerSettingsAddPriceListErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAddPriceListUI";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsAddPriceListErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Pricing list Is Displayed Successfully");
	        	Pages.BillerSettingPricelistPage.navigatePriceList(Log);
	        	
	        	Log.ReportEvent("INFO", "Step4 : Verify Add pricing list is Suceessfull");
	        	Pages.BillerSettingPricelistPage.AddPriceListErrorMessageValidation(testdatamap);
