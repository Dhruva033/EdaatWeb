/**
*
*Test Script Name                       : BillerLoginChangeLanguage.
*TestDataSheet                          : BillerLogin
* Objective                             : Verify to change the language
* Version                               : 1.0
...
public class AdminLoginChangeLanguage {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminLoginChangeLanguage";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminLoginChangeLanguage(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerLoginPage.ChangeLanguage(Log);	
