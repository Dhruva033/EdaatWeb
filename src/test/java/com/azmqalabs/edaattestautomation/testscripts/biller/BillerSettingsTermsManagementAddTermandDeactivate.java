...
* Test Script Name                      : BillerSettingsProductManagementAddInActivate .
* Objective                             : Verify to add product & De-Activate/Verify status toggel.
* Version                               : 1.0
* Author                                : Kathirvelu M
...
* Pre-Conditions                        : 
* Manual Testcase Name                  : BillerSettingsProductManagementAddInActivate.
* Epic Details                          : N/A
...
public class BillerSettingsTermsManagementAddTermandDeactivate {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAddTermDect";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsTermsManagementAddTermandDeactivate(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingTermsManagementPage.AddTermAndDeActivate(testdatamap, Log);
