/**
*
* Test Script Name                   : AdminViewInvoiceIndividualClient.
* TestData Sheet Name                : AdminViewInvoiceIndividualClint
* Objective                          : Verify View Invoice Functionality.
* Version                            : 1.0
* Author                             : Kathirvelu M
...
* Pre-Conditions                     : 1)Admin Logged in with valid Credentials. 
                                       2)Invoice of individual client should be present.
* Epic Details                       : N/A
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminIndividualClientPage.ViewIndividualClientInvoice(testdatamap,Log);
