 /**
*
* Test Script Name                   : AdminReceivablesExportBillsRecurringInvoiceDetailsErrorMsg
* Test data sheet Name               : AdminReceivableExportBilInVoice
* Objective                          : 1.Verfiy Exported Bills Error messages  of Invoice due date under Receivables Module.
                                       2.Verfiy Exported Bills Error messages  of Invoice Expiry date under Receivables Module.
                                       3.Verfiy Exported Bills Error messages  of From Hour Text Fields under Receivables Module.
                                       4.Verfiy Exported Bills Error messages  of To Time  Text Fields under Receivables Module.
                                       5.Verfiy Exported Bills Error messages  of  Condition Text Field under Receivables Module.
...
public class AdminReceivablesExportBillsRecurringInvoiceDetailsErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReceivableExportBilInVoice";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReceivablesExportBillsRecurringInvoiceDetailsErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReceivablesExportedbillsPage.InvoiceError(testdatamap);
