/**
*
* Test Script Name                   : AdimBillerUnderActivationAddMinInvoiceAmountCanBeCheckedByAdmin
* Test Data Sheet Name				 : AdmBillUndActAddMinInvChkBox
* Objective                          : Verify that a new check box "add minimum invoice amount " can be checked by admin under System Management module
* Version                            : 1.0
...
public class AdimBillerUnderActivationAddMinInvoiceAmountCanBeCheckedByAdmin {
	...
	// DECLARATION SECTION
	  static String TestDataTab="AdmBillUndActAddMinInvChkBox";  
