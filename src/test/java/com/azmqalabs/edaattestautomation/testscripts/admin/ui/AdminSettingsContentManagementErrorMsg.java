/**
*
* Test Script Name                   : AdminSettingsContentManagementErrorMsg 
* TestData Sheet Name                : AdminContentMgmErrMsg 
* Objective                          : Verify to content management error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminSettingsContentManagementErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminContentMgmErrMsg";  
	...
	public AdminSettingsContentManagementErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Log.ReportEvent("INFO", "Step3 : Verify Error message in Content Management page  is Suceessful");
			Pages.AdminSettingsContentManagementPage.VerifyContentMgmErrorMsg(testdatamap,Log);
