 /**
*
* Test Script Name                   : AdminSubBillerCorpSubBillerNationalAddressErrorMsg
* Test data sheet Name               : AdminCorpSubBillerNationalInfo
* Objective                          : 1.Verify Add Corporate SubBiller Error message of City dropdown under subBiller Module.
                                       2.Verify Add Corporate SubBiller Error message of District Name text field under subBiller Module.
                                       3.Verify Add Corporate SubBiller Error message of Street Name text field  under subBiller Module.
                                       4.Verify Add Corporate SubBiller Error message of Zip Code text field under subBiller Module.
                                       5.Verify Add Corporate SubBiller Error message of Building Number text field under subBiller Module.
                                       6.Verify Add Corporate SubBiller Error message of Employee Name text field under subBiller Module.
                                       7.Verify Add Corporate SubBiller Error message of Employee Email text field  under subBiller Module.
                                       8.Verify Add Corporate SubBiller Error message of Employee Mobile number text field under subBiller Module.
                                       9.Verify Add Corporate SubBiller Error message of Attach IBAN Image  under subBiller Module.
                                       10.Verify Add Corporate SubBiller Error message of Attach CR Certificate under subBiller Module.
* Version                            : 1.0
...
public class AdminSubBillerCorpSubBillerNationaladdAndContactInfoErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminCorpSubBillerNationalInfo";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSubBillerCorpSubBillerNationaladdAndContactInfoErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSubbillerPage.SubBillerNationalInfoDetails(testdatamap);
