/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndMasterFeesFixed.
* Test Data Sheet                    : BillerReceAzmFixPerMasterFix
* Objective                          : Verify the fees deduction correctly in  Balance details page when AZM Fees [ Fixed & Percentage] and Master Fees[ Fixed ] under Receivables Balance details.
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndMasterFeesFixed {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceAzmFixPerMasterFix";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndMasterFeesFixed(Map<Object, Object> testdatamap){
