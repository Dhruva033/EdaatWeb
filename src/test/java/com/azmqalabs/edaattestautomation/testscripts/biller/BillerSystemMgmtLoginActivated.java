/**
*
* Test Script Name                      :BillerSystemMgmtLoginActivated.
*TestDataSheet                          : BillerSystemMgmtactivatedChkapp
* Objective                             :Verify to login with activated Biller account.
* Version                               : 1.0
...
public class BillerSystemMgmtLoginActivated {
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSystemMgmtLoginActivated(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerLoginPage.LoginToApplication(testdatamap.get("BillerUserName").toString(),testdatamap.get("BillerPassword").toString(),Log);
	           	...
	           	Pages.BillerLoginPage.ExistsCheckElement(EdaatOR.Biller_HomePage_Main,Log);
