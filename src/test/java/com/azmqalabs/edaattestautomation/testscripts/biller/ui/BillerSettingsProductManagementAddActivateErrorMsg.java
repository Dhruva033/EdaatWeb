/**
*
* Test Script Name                      : BillerSettingsProductManagementAddActivate.
*TestDataSheet                          : BillerActiveProduct
* Objective                             : Verify to add product & Activate/ Verify status toggel
* Version                               : 1.0
* Author                                : Kathirvelu Mohan
* Created Date                          : 02/06/2023
* Last Updated on                       : N/A
* Updated By                            : Obalanayak M S
* Pre-Conditions                        : Active Biller Account Should be Present
* Epic Details                          : N/A
...
public class BillerSettingsProductManagementAddActivateErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAddProductActivate";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsProductManagementAddActivateErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsPage.navigateProduct(Log);
	        	...
	        	Log.ReportEvent("INFO", "Step4 : Verify Product Management Active/Deactivate functionality Is Suceessfull");
	        	Pages.BillerSettingsPage.AddProductErrorMessageValidation(testdatamap);
