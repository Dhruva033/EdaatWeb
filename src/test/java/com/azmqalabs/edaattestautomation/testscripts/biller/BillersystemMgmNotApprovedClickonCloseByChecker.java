/**
*
* Test Script Name                   : BillersystemMgmNotApprovedClickonCloseByChecker
* TestDataSheet                      : BillerSystemMgmtCloseChecker
* Objective                          : Verify to check the activation info from checker side to approve account activation.
* Version                            : 1.0
* Author                             : Kathirvelu Mohan
* Created Date                       : 15/06/2023
* Last Updated on                    : N/A
* Updated By                         : Obalanayak M S
* Pre-Conditions                     : 1)Checker Login Credentials 2) Biller Account Details.
* Epic Details                       : N/A
...
public class BillersystemMgmNotApprovedClickonCloseByChecker {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSystemMgmtCloseChecker";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillersystemMgmNotApprovedClickonCloseByChecker(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerLoginPage.LoginToApplication(testdatamap.get("UserName").toString(), testdatamap.get("Password1").toString(),Log);
	        	
	        	
	        	Pages.BillerSystemMangementPage.UpdateData(testdatamap,Log);
	        	
	        	Pages.BillerLoginPage.Logout(EdaatOR.Logout,Log);
	        	
	        	Pages.BillerLoginPage.LoginToApplication(testdatamap,Log);
	        
	        	Pages.BillerSystemMangementPage.ClickonCloseButton(testdatamap,Log);
