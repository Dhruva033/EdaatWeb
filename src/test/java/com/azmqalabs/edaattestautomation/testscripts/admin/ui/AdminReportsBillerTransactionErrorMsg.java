/**
*
* Test Script Name                   : AdminReportsBillerTransactionErrorMsg 
* TestData Sheet Name                : AdminBillerTransactionErrMsg
* Objective                          : Verify Biller Transaction report error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminReportsBillerTransactionErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminBillerTransactionErrMsg";  
	...
	public AdminReportsBillerTransactionErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminReportsAdminReportsPage.VerifyBillerTransactionReportErrorMsg(testdatamap,Log);
