...
*TestDataSheet                       : BillerDetailsUpdate
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerDetailsUpdate(Map<Object, Object> testdatamap){
	        ...
	        this.UserName=testdatamap.get("UserName").toString();
	  	    ...
	  	    this.PaymentType=testdatamap.get("PaymentMethod").toString();
	    }
	    @Override
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSystemMangementPage.UpdateBillerdetails(Billername, MonthlyLimits, Transfers, AZMFees, SadadFees, CorporateName, MaximumAmt,PaymentType,Log);
