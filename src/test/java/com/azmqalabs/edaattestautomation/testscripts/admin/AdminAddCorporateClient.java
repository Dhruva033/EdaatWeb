...
* TestData Sheet Name                : AdminAddCorporateClient
* Objective                          : Verify  Add corporate functionality
* Version                            : 1.0
* Author                             : Kathirvelu M
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminCorporatePage.AddCorporateclient(CorporateName,CRNumber,PersonName,PersonID,MobileNo,Email,ClientRefno,Log);
