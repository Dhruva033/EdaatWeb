/**
* Test Script Name  				 : BillerSearchDiscount.
* TestDataSheet                      : BillerSearchDiscount
* Objective     					 : To Verify Search Discount  functionality.
* Version      						 : 1.0
* Author       						 : Kathirvelu Mohan
* Created Date 			      		 : 24/05/2023
* Last Updated on					 : N/A
* Updated By   			 			 : Obalanayak M S 
* Pre-Conditions					 : Active Biller Login Details and Discount Deatils
* Epic Details						 : N/A
...
public class BillerSearchDiscount {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSearchDiscount";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSearchDiscount(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsDiscountPage.SearchDiscount(testdatamap,Log);
