/**
*
* Test Script Name                   : AdminReceivableReportsClientAccountStatementErrorMsg 
* TestData Sheet Name                : AdminClientAcStatementErrMsg
* Objective                          : Verify Client Account Statement report error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminReceivableReportsClientAccountStatementErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminClientAcStatementErrMsg";  
	...
	public AdminReceivableReportsClientAccountStatementErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminReportsReceivablesReportsPage.VerifyClientAccountStatementReportErrorMsg(testdatamap,Log);
