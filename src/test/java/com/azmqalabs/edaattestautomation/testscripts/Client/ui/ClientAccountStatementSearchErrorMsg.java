...
public class ClientAccountStatementSearchErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientReportsErrorMsg";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientAccountStatementSearchErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.ClientReportsClientAccountStatementPage.VerifySerachFunctionalityErrorMsg(testdatamap,Log);
