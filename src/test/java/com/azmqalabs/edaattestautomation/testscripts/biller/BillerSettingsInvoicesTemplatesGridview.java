/**
* Test Script Name  				 : BillerSettingsInvoicesTemplatesGridview.
* TestDataSheet                      : BillerInvoicesTemplatesGridview
* Objective     					 : To  Verify Grid view details.
* Version      						 : 1.0
...
public class BillerSettingsInvoicesTemplatesGridview {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerInvoicesTemplatesGridview";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsInvoicesTemplatesGridview(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsInvoicesTemplatesPage.verifyInvoiceTemplateGridview(EdaatOR.Biller_Settings_Invoice_template,EdaatOR.Biller_Invoice_Templategridview,Log);
