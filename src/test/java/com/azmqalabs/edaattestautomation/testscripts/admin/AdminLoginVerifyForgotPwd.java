/**
* Test Script Name                      : AdminLoginVerifyForgotPwd
* Test Data Sheet Name                  : AdminForgotPwd
...
public class AdminLoginVerifyForgotPwd {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminForgotPwd";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminLoginVerifyForgotPwd(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminLoginPage.VerifyForgotPassword(testdatamap,Log);
