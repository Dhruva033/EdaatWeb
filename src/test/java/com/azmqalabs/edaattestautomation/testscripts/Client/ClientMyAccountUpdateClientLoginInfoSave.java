/**
*
* Test Script Name                      : ClientMyAccountUpdateClientLoginInfoSave.
* Testdata Sheet Name                   : UpdateClientLoginInfoSave.
* Objective                             : Verify to update client Login Info & Save under My account module.
* Version                               : 1.0
...
public class ClientMyAccountUpdateClientLoginInfoSave {
	
	// DECLARATION SECTION
	  static String TestDataTab="UpdateClientLoginInfoSave";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientMyAccountUpdateClientLoginInfoSave(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.ClientMyAccountPage.UpdateClientLoginInfoSave(testdatamap,Log);
