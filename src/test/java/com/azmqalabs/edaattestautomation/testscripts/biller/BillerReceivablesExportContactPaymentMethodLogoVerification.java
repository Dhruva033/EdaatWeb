/**
*
* Test Script Name                      : BillerReceivablesExportContactPaymentMethodLogoVerification
* Test Data Sheet                       : BillerExportContractPayment
* Objective                             : Verify Add new search criteria in Exported contracts page for the payment method
* Version                               : 1.0
* Author                                : Kathirvelu Mohan
* Created Date                          : 22/04/2024
* Last Updated on                       : N/A
* Updated By                            : Radhika K R
* Pre-Conditions                        : Biller should be logged in with valid credentials
* Epic Details                          : N/A
...
public class BillerReceivablesExportContactPaymentMethodLogoVerification {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerExportContractPayment";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportContactPaymentMethodLogoVerification(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.verifyPaymentMethodLogoInContractNumber(testdatamap, Log);	        	
