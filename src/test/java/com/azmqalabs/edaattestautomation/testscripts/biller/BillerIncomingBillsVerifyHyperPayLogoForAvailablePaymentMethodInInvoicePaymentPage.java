/**
*
* Test Script Name                      : BillerIncomingBillsVerifyHyperPayLogoForAvailablePaymentMethodInInvoicePaymentPage.
* Test Data Sheet                       : BillerIncomingBillsHyperPayLogo.
* Objective                             : [Biller] Verify hyper pay logo  for each  available payment method in the invoice payment page
* Version                               : 1.0
* Author                                : Kalpana I R
...
public class BillerIncomingBillsVerifyHyperPayLogoForAvailablePaymentMethodInInvoicePaymentPage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerIncomingBillsHyperPayLogo";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerIncomingBillsVerifyHyperPayLogoForAvailablePaymentMethodInInvoicePaymentPage(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerPayablesPage.VerifyHyperPayLogoForPaymentMethods(testdatamap, Log);
