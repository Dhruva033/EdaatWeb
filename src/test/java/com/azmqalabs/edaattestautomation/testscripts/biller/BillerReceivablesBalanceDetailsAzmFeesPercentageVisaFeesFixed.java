/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesPercentageVisaFeesFixed.
* Test Data Sheet                    : BillerAzmPercentVisaFeesFixed
* Objective                          : Verify the fees deduction correctly  inBalance details page when AZM Fees [ Percentage] and Visa Fees[ Fixed]
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesPercentageVisaFeesFixed {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAzmPercentVisaFeesFixed";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesPercentageVisaFeesFixed(Map<Object, Object> testdatamap){
