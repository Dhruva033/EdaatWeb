/**
* Test Script Name  				 : BillerSettingsPricingListSearch.
* TestDataSheet                      : BillerPriceListSearch
* Objective     					 : To  Verify search Pricelist functionality
* Version      						 : 1.0
...
public class BillerSettingsPricingListSearch {
	
	// DECLARATION SECTION
		  static String TestDataTab="BillerPriceListSearch";  
		  ...
		  DBUtil DBUtil;
		    ...
		    public  BillerSettingsPricingListSearch(Map<Object, Object> testdatamap){
...
//		    @Parameters({ "username", "password" })
		    ...
		    public void myTest() throws InterruptedException, Exception{
		        try{
		        	...
		        	Pages.BillerSettingPricelistPage.verifySearchFunctionality(testdatamap,Log);
