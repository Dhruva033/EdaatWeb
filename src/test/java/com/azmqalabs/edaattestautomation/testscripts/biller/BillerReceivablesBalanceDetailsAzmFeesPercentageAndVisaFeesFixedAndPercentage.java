/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesPercentageAndVisaFeesFixedAndPercentage
* Test Data Sheet                    : BillerRecAzmFeesPerVisaFixedPer
* Objective                          : Verify the fees deduction correctly in   Balance details page when AZM Fees [ Percentage] and Visa Fees[ Fixed & Percentage].
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesPercentageAndVisaFeesFixedAndPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerRecAzmFeesPerVisaFixedPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesPercentageAndVisaFeesFixedAndPercentage(Map<Object, Object> testdatamap){
