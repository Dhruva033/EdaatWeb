/**
*
* Test Script Name                   : AdminSubBillersCorporateSubBillerFeesDeductionInvoiceErrorMsg 
* Test data sheet Name               : AdminSubBillerErrorMsgAllfields
* Objective                          : 1.Verify SubBiller Error Message of Select Operation Fees Deduction Method checkbox under Corporate subbiller.
                                       2.Verify SubBiller Error Message of Fixed Value textfield under Corporate subbiller.
                                       3.Verify SubBiller Error Message of Percentage text field under Corporate subbiller.
                                       4.Verify SubBiller Error Message of Fees Deduction from Invoice Total Amount checkbox under Corporate subbiller.
* Version                            : 1.0
...
public class AdminSubBillersCorporateSubBillerFeesDeductionInvoiceErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminSubBillerErrorMsgAllfields";  
	...
	public AdminSubBillersCorporateSubBillerFeesDeductionInvoiceErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSubbillerPage.CorporateSubBillerErrorMsg(testdatamap);
