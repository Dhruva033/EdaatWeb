/**
*
* Test Script Name                   : AdminSubBillersCorporateSubbillersadd. 
* Test data sheet Name               : AdminCorporateSubAdd.
* Objective                          : Verify to add Corporate Subbiller under Subbiller module.
* Version                            : 1.0
...
public class AdminSubBillersCorporateSubbillersadd {

	// DECLARATION SECTION
	static String TestDataTab="AdminCorporateSubAdd";  
	...
	public AdminSubBillersCorporateSubbillersadd(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSubbillerPage.AddCorporatesubbiller(testdatamap,Log);
