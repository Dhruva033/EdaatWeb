/**
*
* Test Script Name                   : AdminReportsClientTypeErrorMsg 
* TestData Sheet Name                : AdmiClientTypeReportErrMsg
* Objective                          : Verify Client Type Report error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminReportsClientTypeErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdmiClientTypeReportErrMsg";  
	...
	public AdminReportsClientTypeErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminReportsAdminReportsPage.VerifyClientsTypeReportErrorMsg(testdatamap,Log);
