/**
*
* Test Script Name                   : AdminUpdateIndividualClient
* TestData Sheet Name                : AdminUpdateIndividualClient
* Objective                          : Verify Edit Client Functionality
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminUpdateIndividualClient {
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminIndividualClientPage.UpdateIndividualClient(FullName,SecondName,ThirdName,LastName,NationalID,Year,Month,Date,MobileNo,Email,Refno,Log);
