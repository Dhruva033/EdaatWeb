...
public class BillerReceivablesBalanceDetailsAzmFeesPercentageAndMasterFeesFixed {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAzmFeesPerAndMasterFix";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesPercentageAndMasterFeesFixed(Map<Object, Object> testdatamap){
