...
**/
	...
	public void myTest() throws InterruptedException, Exception{
	    try{
	    	...
	    	Pages.BillerLoginPage.ForgetPassword(EdaatOR.LoginPage_Forgetlink,Username, Log);
	    	Pages.BillerLoginPage.ExistsCheckElement(EdaatOR.LoginPage_confirmation, Log);
