/**
*
* Test Script Name                   : AdminLoginFooterLinks
* Test data sheet Name               : AdminLoginFooterLinks 
* Objective                          : Verify the linkes in the Footer page under
* Version                            : 1.0
* Author                             : Kalpana I R
...
public class AdminLoginFooterLinks {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminLoginFooterLinks";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminLoginFooterLinks(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	//to check Home page
	           	Pages.AdminLoginPage.footerlinks(Log);
