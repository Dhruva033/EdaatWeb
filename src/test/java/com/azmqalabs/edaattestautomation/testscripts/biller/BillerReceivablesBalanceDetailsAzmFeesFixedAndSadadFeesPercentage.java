...
public class BillerReceivablesBalanceDetailsAzmFeesFixedAndSadadFeesPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAzmFeesFixAndSadadFeesPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedAndSadadFeesPercentage(Map<Object, Object> testdatamap){
