/**
* Test Script Name                   : AdminAddCorpoSubBillerFeeDeductiononProduct
* Objective                          : Verify to add sub Biller with Fees Deduction Based on Product under subBiller module.
* Version                            : 1.0
* Author                             : Kathirvelu M
* Created Date                       : 14/06/2023
* Last Updated on                    : N/A
* Updated By                         : Obalanayaka
* Pre-Conditions                     : Admin Login credentials
* Manual Testcase Name               : AdminAddCorporateClient
* Epic Details                       : N/A
...
public class AdminAddCorpoSubBillerFeeDeductiononProduct {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminAddCorpSubBillerFeeDeduPro";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminAddCorpoSubBillerFeeDeductiononProduct(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSubbillerPage.CorporateSubBillersAdd(testdatamap,Log);
