/**
*
* Test Script Name                   : BillerReceivablesPaidOutsideEdaatGridView.
* Test Data Sheet                    : BillerReceivablesPaidOutEdaat.
* Objective                          : Verify Grid details view.
* Version                            : 1.0
...
public class BillerReceivablesPaidOutsideEdaatGridView {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceivablesPaidOutEdaat";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesPaidOutsideEdaatGridView(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesPaidOutsideEdaatPage.GridView(EdaatOR.Biller_PaidOustSideEdaat_link,EdaatOR.Biller_Receivables_PaidOutside_Table,Log);
