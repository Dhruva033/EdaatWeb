 ...
 /**
* Test Script Name                   : AdminMyAccountNotificationVerifySMSToggle
* TestData sheet Name                : AdminMyaccountSMSToggle
* Objective                          : Verify Send SMS toggle
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminMyAccountNotificationVerifySMSToggle {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminMyaccountSMSToggle";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminMyAccountNotificationVerifySMSToggle(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminMyAccountPage.VerifySendSMStoggle(Log);
