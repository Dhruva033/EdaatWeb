/**
* Test Script Name                   : AdminClientsEditCorporateClientErrorMsg
* TestData Sheet Name                : AdminEditCorporateClientErr
* Objective                          : Verify  Edit corporate client error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminClientsEditCorporateClientErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminEditCorporateClientErr";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminClientsEditCorporateClientErrorMsg(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminCorporatePage.VerifyEditCorpClietErrorMsg(CorporateName,CRNumber,PersonName,PersonID,MobileNo,Email,ClientRefno,ExpectedResult);
