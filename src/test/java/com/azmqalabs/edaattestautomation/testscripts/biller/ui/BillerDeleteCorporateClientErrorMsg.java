/**
* Test Script Name  				 : BillerDeleteCorporateClient.
* Test Data SheetName				 : BillerDeleteCorporateClientErr
* Objective     					 : Verify Delete Corporate client page  fields validation.
* Version      						 : 1.0
...
public class BillerDeleteCorporateClientErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerDeleteCorporateClientErr";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerDeleteCorporateClientErrorMsg(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Delete Corporate Client page fileds validation Suceessfull");
	        	Pages.BillerCorporatePage.VerifyDeleteCorpClietErrorMsg( ExpectedResult);
