/**
*
* Test Script Name                   : BillerUserGrpMgmAddErrorMsg
* TestDataSheet                      : BillerAddNewGroupUI
* Objective                          : 1)Verify to add new group
*                                      2)Verify to view the users under this group 
* Version                            : 1.0
...
public class BillerUserGrpMgmAddErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAddNewGroupUI";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerUserGrpMgmAddErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerUserGroupManagementPage.AddGroupErrorMsgValidation(testdatamap);
