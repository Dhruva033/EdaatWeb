/**
* Test Script Name  				 : BillerReceivableReportsSuperBillerSadadPaymentTransactions
* Test Data Sheet Name				 : BillerSadadPaymentReport
* Objective     					 : Verify Sadad Payments Transactions Report
* Version      						 : 1.0
...
* Pre-Conditions					 : 1)Biller logged in with valid credentials
                                       2)Sadad payments should be present
* Epic Details						 : N/A
...
public class BillerReceivableReportsSuperBillerSadadPaymentTransactions {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSadadPaymentReport";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivableReportsSuperBillerSadadPaymentTransactions(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReportReceivableReportforSuperBillerPage.VerifySadadPaymentsTransactions(testdatamap, Log);
