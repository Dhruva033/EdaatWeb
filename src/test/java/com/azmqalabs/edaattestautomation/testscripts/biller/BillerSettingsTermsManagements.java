/**
*
* Test Script Name                   : BillerSettingsTermsManagements
* Test Data Sheet                    : BillerTermsmanagementview
* Objective                          : Verify GridView Functionality under Terms Management.
* Version                            : 1.0
...
public class BillerSettingsTermsManagements{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerTermsmanagementview";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsTermsManagements(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", className+" Execution Started");
	           	...
	           	Pages.BillerSettingTermsManagementPage.VerifyGridView(Log);
