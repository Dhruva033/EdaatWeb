/**
*
* Test Script Name  				 : BillerAddInvoicetemplateErrorMsg.
* TestDataSheet                      : BillerAddInvoicesTemplatesUI
* Objective     					 : 1)Verify to add One Time Invoice template. 
									   2)Verify to add Recurring Invoice template. 
...
* Pre-Conditions					 : Active Biller Login Credentials Should be Present                          
* Epic Details						 : N/A
...
public class BillerAddInvoicetemplateErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAddInvoicesTemplatesUI";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerAddInvoicetemplateErrorMsg(Map<Object, Object> testdatamap){
	        ...
	        this.TemplateDescription=testdatamap.get("TemplateDescription").toString();
	        this.TemplateReferancecode=testdatamap.get("TemplateReferancecode").toString();
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsPage.AddInvoicetemplateUI(testdatamap);
