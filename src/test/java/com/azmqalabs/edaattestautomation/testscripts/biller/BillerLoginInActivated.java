...
* Test Script Name                      : BillerLoginInActivated.
* Objective                             :Verify to login with inactivated Biller account.
* Version                               : 1.0
* Author                                : Kathirvelu M
...
* Pre-Conditions                        : 
* Manual Testcase Name                  : BillerLoginInActivated.
* Epic Details                          : N/A
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerLoginPage.LoginToApplication(testdatamap.get("BillerUserName").toString(),testdatamap.get("BillerPassword").toString(),Log);     	        	
	           	Pages.BillerLoginPage.ExistsCheckElement(EdaatOR.LoginPage_Error_Invalid, Log);      
