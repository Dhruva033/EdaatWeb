/**
*
* Test Script Name                   : BillerReceivablesBalanceSearch.
* Test Data Sheet                    : BillerReceivablesBalanceSearch.
* Objective                          : Verify Search functionality under Receivables Balance details.
* Version                            : 1.0
...
public class BillerReceivablesBalanceSearchErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceivableBalanceSearchUi";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceSearchErrorMsg(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify to Naviagte Balance details  is Suceessfull");
	        	Pages.BillerReceivablesBalancePage.NavgateReceivable(Log);
	        	
	        	Log.ReportEvent("INFO", "Step4 : Verify Search functionality is Suceessfull");
	        	Pages.BillerReceivablesBalancePage.BalanceSearchUi(testdatamap);
