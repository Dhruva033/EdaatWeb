/**
*
* Test Script Name                   : BillerSubBillerAddIndividual.
* Test Data Sheet                    : BillerSubBillerAddIndividual
* Objective                          : Verify to add sub Biller with Fees Deduction Based on Product
* Version                            : 1.0
...
public class BillerSubBillerIndividualProductErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSubBillerAddIndividuaUi";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSubBillerIndividualProductErrorMsg(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify to add sub Biller with Fees Deduction Based on Product is successfull");
	        	Pages.BillerSubbillerPage.SubBillerIndividualUi(testdatamap);
