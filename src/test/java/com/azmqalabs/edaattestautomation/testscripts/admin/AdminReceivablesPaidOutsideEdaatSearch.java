/**
* Test Script Name                   : AdminReceivablesPaidOutsideEdaatSearch
* Test Data sheet Name				 : AdminReceivablesPOESearch
* Objective                          : Verify Search functionality of Paid Outside Edaat under Receivables module.
* Version                            : 1.0
* Author                             : Kathirvelu M
* Created Date                       : 
* Last Updated on                    : N/A
...
public class AdminReceivablesPaidOutsideEdaatSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReceivablesPOESearch";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReceivablesPaidOutsideEdaatSearch(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	//Pages.AdminReceivablesExportedbillsPage.naviagteReveiableExportAdmin(Log);
	           	...
	           	Pages.AdminReceivablesPaidOutsideEdaatPage.paidOutsideEdaatSearch(testdatamap,Log);
