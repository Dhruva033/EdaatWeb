...
public class BillerImportClientBulkData {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerImportclientBulkdata";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerImportClientBulkData(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerImportClientdataPage.ImportBulkData(testdatamap, Log);
