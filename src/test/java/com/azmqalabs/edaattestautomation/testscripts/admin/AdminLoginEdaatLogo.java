/**
*
* Test Script Name                      : AdminLoginEdaatLogo.
...
public class AdminLoginEdaatLogo {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminLoginEdaatLogo";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminLoginEdaatLogo(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminLoginPage.VerifyEdaatLogo(Log);
