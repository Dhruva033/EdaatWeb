/**
*
* Test Script Name                   : AdminReceivablesExportContact
* Test data sheet Name               : AdminReceivableExportContact
* Objective                          : 1.Verfiy view installments for exported contracts under Receivables Module.
                                       2.Verify contract number is clickable  under Receivables Module.
                                       3.Verify printout functionality for the contracts  under Receivables Module.
                                       4.Verify view installments is clickable  under Receivables Module.
* Version                            : 1.0
	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReceivablesExportedbillsPage.naviagteReveiableExportContact();
	        	
	        	Pages.AdminReceivablesExportedbillsPage.verifyExportContact(testdatamap,Log);
