/**
* Test Script Name                      : ClientPayablesIncommingBillsPrint
* Test Data Sheet Name                  : ClientIncomingBillsPrint
* Objective                             : Verify printout Functionality for the Bills under Incoming Bills
* Version                               : 1.0
...
public class ClientPayablesIncommingBillsPrint {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientIncomingBillsPrint";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientPayablesIncommingBillsPrint(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.ClientPayablesIncomingBillsPage.verifyBillsPrint(testdatamap,Log);
