/**
*
* Test Script Name                   : AdminReceivablesSaveBills
* Test data sheet Name               : AdminReceivableSaveBills
* Objective                          :1.Verfiy create and save one time invoice under Receivables Module.
                                      2.Verfiy create  installments invoice  under Receivables Module.
* Version                            : 1.0
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReceivablesExportedbillsPage.naviagteReveiableExportAdmin(Log);
	           	...
	           	Pages.AdminReceivablesExportedbillsPage.createSaveInvoiceData(testdatamap,Log);
