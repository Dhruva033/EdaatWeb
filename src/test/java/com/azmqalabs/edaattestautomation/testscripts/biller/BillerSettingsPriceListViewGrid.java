/**
*
* Test Script Name                      : BillerSettingsPriceListViewGrid.
* TestDataSheet                         : BillerPriceView
* Objective                             : Verify to view grid view details in 
                                          price list under Settings module.
* Version                               : 1.0
...
public class BillerSettingsPriceListViewGrid {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerPriceListgridview";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsPriceListViewGrid(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingPricelistPage.navigatePricingList(Log);
	        	Pages.BillerSettingPricelistPage.verifyPricelistgridview(Log);
