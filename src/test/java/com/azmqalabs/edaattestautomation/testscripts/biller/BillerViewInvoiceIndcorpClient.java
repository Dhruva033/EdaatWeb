/**
* Test Script Name                   : BillerViewInvoiceIndcorpClient
* Test Data SheetName				 : BillerViewInvoiceIndividualClt
* Objective                          : Verify Invoice details for individual and corporate client Functionality
* Version                            : 1.0
* Author                             : Kathirvelu M
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerIndividualClientPage.ViewIndividualClientInvoice(testdatamap, Log);
