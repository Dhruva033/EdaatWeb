/**
* Test Script Name  				 : BillerImportClientData_SelectType
* Objective     					 : Verify to select the type of the customer
* Version      						 : 1.0
* Author       						 : Kathirvelu M
...
* Manual Test case Name				 : BillerImportClientData_SelectType
* Epic Details						 : N/A
* User Story Details				 : N/A
* Defects affecting this test script : None
* WorkArounds/Known Issues			 : None
**/
...
public class BillerImportClientData_SelectType {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerImportType";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerImportClientData_SelectType(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerImportClientdataPage.SelectTypeofCustomer(testdatamap, Log);
