/**
* Test Script Name                   : MyBillsValidateCorrectClientIsLoginToTheClientAccount
* Test Data Sheet Name				 : MyBillsvalid
* Objective                          : verify that when entering the contract number and redirecting to login as client they log by the correct client under My Bills module
* Version                            : 1.0
...
* Pre-Conditions                     : 1)Valid Admin Login Credentials
									 : 2)Valid Contract Number should be present
* Epic Details                       : N/A
...
public class MyBillsValidateCorrectClientIsLoginToTheClientAccount {
	
	// DECLARATION SECTION
	  static String TestDataTab="MyBillsCorrectClient";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public MyBillsValidateCorrectClientIsLoginToTheClientAccount(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.MyBillsPage.clickOnMyBillMenu(Log);
	        	
	        	Pages.MyBillsPage.enterTheContractNumberAndClickOnPayNowButton(testdatamap,Log);
	        	
	        	Pages.ClientLoginPage.LoginToApplication(testdatamap,Log);
	        	
	        	Pages.ClientLoginPage.validateCorrectClientIsLoginToTheClientAccount(testdatamap,Log);
