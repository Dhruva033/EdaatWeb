/**
*
* Test Script Name                   : AdminReportsCorporateClientErrorMsg 
* TestData Sheet Name                : AdminCorpoClientReportErrMsg
* Objective                          : Verify Corporate client report error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminReportsCorporateClientErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminCorpoClientReportErrMsg";  
	...
	public AdminReportsCorporateClientErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminReportsAdminReportsPage.VerifyCorporateClientReportErrorMsg(testdatamap,Log);
