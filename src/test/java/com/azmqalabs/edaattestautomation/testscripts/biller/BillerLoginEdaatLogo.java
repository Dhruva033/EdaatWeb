/**
*
* Test Script Name                      : BillerLoginEdaatLogo.
* TestData sheet Name                   : BillerLoginEdaatLogo
* Objective                             : Verify to click on EDAAT logo and navigate to home page.
* Version                               : 1.0
* Author                                : Kathirvelu M
...
public class BillerLoginEdaatLogo {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerLoginEdaatLogo";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerLoginEdaatLogo(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerLoginPage.VerifyEdaatLogo(Log);
