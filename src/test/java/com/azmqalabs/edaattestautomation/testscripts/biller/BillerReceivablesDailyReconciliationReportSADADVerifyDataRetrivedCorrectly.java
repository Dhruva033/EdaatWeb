/**
*
* Test Script Name                   : BillerReceivablesDailyReconciliationReportSADADVerifyDataRetrivedCorrectly.
* Test Data Sheet                    : BillerReceDRReportsVerifyData.
* Objective                          : verify that when searching by Transfer Status the data retrieved correctly.
* Version                            : 1.0
...
public class BillerReceivablesDailyReconciliationReportSADADVerifyDataRetrivedCorrectly {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceDRReportsVerifyData";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesDailyReconciliationReportSADADVerifyDataRetrivedCorrectly(Map<Object, Object> testdatamap){
