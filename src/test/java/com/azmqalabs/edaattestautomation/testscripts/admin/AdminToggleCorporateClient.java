/**
*                  
* Test Script Name                   : AdminToggleCorporateClient
* TestData Sheet Name                : AdminToggleCorporateClient
* Objective                          : Verify Activate/Deactivate Clients
* Version                            : 1.0
* Author                             : Kathirvelu M
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminCorporatePage.ActivateDactivate(CorporateName,testdatamap,Log);
