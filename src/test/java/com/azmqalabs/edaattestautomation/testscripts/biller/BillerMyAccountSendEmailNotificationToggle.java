...
* Test Data Sheet Name				 : BillerMyAccountPushNotification under My account module.
* Objective                          : Verify  Send Email toggel
* Version                            : 1.0
* Author                             : Kalpana I R
...
public class BillerMyAccountSendEmailNotificationToggle{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerMyAccountSendEmail";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerMyAccountSendEmailNotificationToggle(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerMyAccountNotificationSettingPage.MyAccountSendEmailToggle(testdatamap, Log);
