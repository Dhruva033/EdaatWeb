/**
*
* Test Script Name                   : AdminSettingGridviewPriceList. 
* Test data sheet Name               : AdminSettingGridView.
* Objective                          : Verify to View price list under Settings module.
* Version                            : 1.0
...
public class AdminSettingGridviewPriceList {

	// DECLARATION SECTION
	static String TestDataTab="AdminSettingsGridViewPrice";  
	...
	public AdminSettingGridviewPriceList(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSettingsPricingListPage.VerifyGridView(testdatamap,Log);
