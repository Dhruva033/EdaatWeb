...
* Test Data SheetName					: BillerSignUp
* Objective                             : Verify Biller Registration Page fields validation.
* Version                               : 1.0
...
public class BillerSignUpErrorMsg {
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSignUpErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step2 : Verify RegistrationPage fields validation is Successfully");
	        	Pages.BillerSignUpPage.BillerRegistrationErrormessageValidation(testdatamap);
