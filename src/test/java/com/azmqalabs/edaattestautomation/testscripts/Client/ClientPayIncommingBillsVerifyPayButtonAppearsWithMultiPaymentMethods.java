/**
* Test Script Name                      : ClientPayIncommingBillsVerifyPayButtonAppearsWithMultiPaymentMethods
* Test Data Sheet Name                  : ClientPayIncomingPaymentMethod
* Objective                             : Verify that the pay button appears for exported bill installment invoices with multi-payment methods Under Payables Module
* 										: Verify hyper pay logo  for each  available payment method in invoice payment page Under Payables Module
* Version                               : 1.0
* Author                                : Dhruva Kumar S
* Created Date                          : 
* Last Updated on                       : N/A
* Updated By                            :
* Pre-Conditions                        : 1)Valid Bill Number should be present
* Epic Details                          : N/A
...
public class ClientPayIncommingBillsVerifyPayButtonAppearsWithMultiPaymentMethods {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientPayIncomingPaymentMethod";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientPayIncommingBillsVerifyPayButtonAppearsWithMultiPaymentMethods(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.ClientPayablesIncomingBillsPage.verifyPayButtonAppearsWithMultiPaymentMethods(testdatamap,Log);
