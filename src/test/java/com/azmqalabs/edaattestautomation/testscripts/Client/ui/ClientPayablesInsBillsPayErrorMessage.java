/**
*
* Test Script Name                      : ClientPayablesInsBillsPayErrorMessage.
* TestData Sheet                        : ClientIncomingbillsPay
* Objective                             : VerifyIncomingbillsPayEroorMessage
* Version                               : 1.0
...
* Manual Testcase Name                  : ClientSignUp.
* Epic Details                          : N/A
...
public class ClientPayablesInsBillsPayErrorMessage {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientIncomingbillsPay";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientPayablesInsBillsPayErrorMessage(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step2 :Verify Client Login is Sucessfull");
	        	Pages.ClientLoginPage.LoginToApplication(testdatamap,Log);

	        	Log.ReportEvent("INFO", "Step2 :Verify IncomingBills Pay ErrorMessage");
	        	Pages.ClientPayablesIncomingBillsPage.VerifyIncomingbillsPayEroorMessage(testdatamap,Log);
