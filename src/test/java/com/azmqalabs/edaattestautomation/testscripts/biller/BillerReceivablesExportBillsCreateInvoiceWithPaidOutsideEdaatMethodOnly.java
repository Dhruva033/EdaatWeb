/**
*
* Test Script Name                      : BillerReceivablesExportBillsCreateInvoiceWithPaidOutsideEdaatMethodOnly
* Test Data Sheet                       : BillerCreateInvoiceWithOnlyPaid
* Objective                             : [Biller]Verify that you can create invoice with paid outside edaat method only 
* Version                               : 1.0
...
public class BillerReceivablesExportBillsCreateInvoiceWithPaidOutsideEdaatMethodOnly {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerCreateInvoiceWithOnlyPaid";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportBillsCreateInvoiceWithPaidOutsideEdaatMethodOnly(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            Pages.BillerReceivablesExportedbillsPage.verifyToCreateInvoiceOnlyForPaidOutsideEdaat(testdatamap, Log);
