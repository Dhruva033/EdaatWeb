 /**
*
* Test Script Name                   : AdminReceivablesExportBillsCreateInvoiceVerifyMinimumAmount
* Test data sheet Name               : AdminExportedBillsMinAmount
* Objective                          : Verify that the validation "add minimum invoice amount "  will be apply when biller create invoice
* Version                            : 1.0
...
public class AdminReceivablesExportBillsCreateInvoiceVerifyMinimumAmount {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminExportedBillsMinAmount";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReceivablesExportBillsCreateInvoiceVerifyMinimumAmount(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReceivablesExportedbillsPage.validateMinimumInvoiceAmount(testdatamap,Log);
