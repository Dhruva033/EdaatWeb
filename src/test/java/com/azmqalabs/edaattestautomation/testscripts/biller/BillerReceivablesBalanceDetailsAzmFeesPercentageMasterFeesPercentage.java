/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesPercentageMasterFeesPercentage.
* Test Data Sheet                    : BillerAzmAndMasterFeesPercentge
...
public class BillerReceivablesBalanceDetailsAzmFeesPercentageMasterFeesPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAzmAndMasterFeesPercentge";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesPercentageMasterFeesPercentage(Map<Object, Object> testdatamap){
