/**
*
* Test Script Name                      : BillerSettingsAddPriceList.
* TestDataSheet                         : BillerAddPriceList
...
public class BillerSettingsAddPriceList {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAddPriceList";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsAddPriceList(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingPricelistPage.navigatePriceList(Log);
	      	    Pages.BillerSettingPricelistPage.addPriceList(testdatamap, Log);
