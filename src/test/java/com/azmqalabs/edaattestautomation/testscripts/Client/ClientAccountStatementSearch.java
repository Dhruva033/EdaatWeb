...
public class ClientAccountStatementSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientReportsAccStatementSearch";  
	  ...
	  String className="";
	    ...
	    public ClientAccountStatementSearch(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
             ...
             Log.ReportEvent("PASS", className+" Execution Started");
	        	...
	        	Pages.ClientReportsClientAccountStatementPage.VerifySerachFunctionality(testdatamap,Log);
