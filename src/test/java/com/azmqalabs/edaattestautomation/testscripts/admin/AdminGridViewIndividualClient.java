/**
*
* Test Script Name                   : AdminGridViewIndividualClient.
* TestData Sheet Name                : AdminViewIndividualClient
...
public class AdminGridViewIndividualClient {
	...
	public AdminGridViewIndividualClient(Map<Object, Object> testdatamap){
		...
		this.ClientName=testdatamap.get("ClientName").toString();
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminIndividualClientPage.TableGridview(ClientName,Log);
