/**
*
* Test Script Name                   : BillerUserGrpMgmDelete
* TestDataSheet                      : BillerUserGroupMgmDelete
* Objective                          : Verify delete group functionality
* Version                            : 1.0
...
public class BillerUserGrpMgmDelete {
	...
	// DECLARATION SECTION
	  static String TestDataTab="BillerUserGroupMgmDelete";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerUserGroupManagementPage.deleteGroup(testdatamap,Log);
