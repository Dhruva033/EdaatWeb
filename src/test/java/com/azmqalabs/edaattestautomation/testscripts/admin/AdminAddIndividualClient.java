/**
*
* Test Script Name                   : AdminAddIndividualClient 
* TestData Sheet Name                : AdminAddIndividualClient
...
public class AdminAddIndividualClient {
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminIndividualClientPage.AddIndividualclient(FullName,SecondName,ThirdName,LastName,NationalID,Year,Month,Date,MobileNo,Email,Refno,Log);
