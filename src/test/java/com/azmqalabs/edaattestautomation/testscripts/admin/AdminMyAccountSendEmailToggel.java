/**
*
* Test Script Name                   : AdminMyAccountSendEmailToggel 
* TestData Sheet Name                : AdminMyAccNotifiSendEmailToggle
* Objective                          : Verify Notification Settings Send Email toggel
* Version                            : 1.0
...
public class AdminMyAccountSendEmailToggel {

	// DECLARATION SECTION
	static String TestDataTab="AdminMyAccNotifiSendEmailToggle";  
	...
	public AdminMyAccountSendEmailToggel(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminMyAccountPage.VerifySendEmailtoggel(Log);
