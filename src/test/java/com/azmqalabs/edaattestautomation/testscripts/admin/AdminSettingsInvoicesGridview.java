/**
*
* Test Script Name                   : AdminSettingsInvoicesGridview.
* TestData Sheet Name                : AdminInvoiceGrid
	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsPage.GridView(EdaatOR.Systemmgmt_InvoiceTemplate,EdaatOR.Systemmgmt_table_Invoice,Log);
