/**
* Test Script Name  				 : BillerReportsReceviablesCustomReconciliationReportDefaultField.
*TestDataSheet                       : BillerCustomReportDefaultField
* Objective     					 : Verify that the default field is checked when entering to Custom reconciliation Report page.
* Version      						 : 1.0
* Author       						 : Kathirvelu Mohan
* Created Date 			      		 : 
* Last Updated on					 : N/A
* Updated By   			 			 : Basavaraj Mudnur
* Pre-Conditions					 : Active Biller Login Credentials
* Epic Details						 : N/A
...
public class BillerReportsReceviablesCustomReconciliationReportDefaultField {

	// DECLARATION SECTION
	static String TestDataTab = "BillerCustomReportDefaultField";
	...
	public BillerReportsReceviablesCustomReconciliationReportDefaultField(Map<Object, Object> testdatamap) {
...
//	    @Parameters({ "username", "password" })
	...
	public void myTest() throws InterruptedException, Exception {
		try {
			...
			Pages.BillerReportsCustomReconciliationReportPage.verifyDefaultFieldsAreChecked(Log);
	...
	public void beforeClass() throws Exception {
		...
		test = ExtentManager.CreateExtentReportTest(extent, className, testdatamap.get("TestDescription").toString(),
				browserFromXML, TestScriptID);
		// INITIALIZE DRIVER
