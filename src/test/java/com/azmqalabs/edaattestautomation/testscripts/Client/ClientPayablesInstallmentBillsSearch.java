/**
*
* Test Script Name                      : ClientPayablesInstallmentBillsSearch.
* Testdata Sheet Name                   : ClientPayableInstallBillSearch.
* Objective                             : Verify Search functionality under payables module.
* Version                               : 1.0
* Author                                : Kalpana I R
* Created Date                          : 
* Last Updated on                       : N/A
...
public class ClientPayablesInstallmentBillsSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientPayableInstallBillSearch";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientPayablesInstallmentBillsSearch(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	    	try{
	    		...
	    		Pages.ClientPayablesInstallmentsBillsPage.InstallmentBillSearch(testdatamap, Log);
