/**
*
* Test Script Name                   : BillerUserListAddErrorMsg
* TestDataSheet                      : BillerUserListAddUserUI
* Objective                          : Verify to add new user account
* Version                            : 1.0
...
public class BillerUserListAddErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerUserListAddUserUI";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerUserListAddErrorMsg(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerUserMngUserListPage.navigateUserlistPage(Log);
	        
	        	Log.ReportEvent("INFO", "Step3 : Verify to add new user account");
	        	Pages.BillerUserMngUserListPage.AddUserErrorvalidation(testdatamap);
