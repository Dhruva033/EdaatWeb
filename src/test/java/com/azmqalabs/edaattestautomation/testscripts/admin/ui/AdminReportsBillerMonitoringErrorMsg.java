/**
*
* Test Script Name                   : AdminReportsBillerMonitoringErrorMsg 
* TestData Sheet Name                : AdminBillerMonitoringErrMsg
* Objective                          : Verify Biller Monitoring Report error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminReportsBillerMonitoringErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminBillerMonitoringErrMsg";  
	...
	public AdminReportsBillerMonitoringErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminReportsAdminReportsPage.VerifyBillerMonitoringReportErrorMsg(testdatamap,Log);
