/**
*
* Test Script Name                   : BillerPayablesIncomingBillsPaymentMethodColumn
* Test Data Sheet                    : BillerIncomingBillsPaymentMetho
* Objective                          : [Biller] Verify Add new columns in incoming bills page for the payment method
* Version                            : 1.0
...
public class BillerPayablesIncomingBillsPaymentMethodColumn{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerIncomingBillsPaymentMetho";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerPayablesIncomingBillsPaymentMethodColumn(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerPayablesPage.IncomingBillsSearch(testdatamap, Log);
	        	Pages.BillerPayablesPage.validatePaymentMethodInGrid(testdatamap, Log);
