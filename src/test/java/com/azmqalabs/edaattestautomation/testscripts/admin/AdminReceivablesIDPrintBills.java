/**
*
* Test Script Name                   : AdminReceivablesIDPrintBills
* Test data sheet Name               : AdminReceivableIDPrintBills
* Objective                          : 1.Verify Bill number is clickable  under Receivables Module.
                                       2.Verify printout functionality for the invocies  under Receivables Module.
* Version                            : 1.0
	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReceivablesExportedbillsPage.verifyInvoiceIDandPrint(testdatamap,Log);
