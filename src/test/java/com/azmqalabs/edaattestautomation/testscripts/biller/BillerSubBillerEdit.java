/**
*
* Test Script Name                   : BillerSubBillerSerachEdit.
* Test Data Sheet                    : BillerSubBillerEdit.
* Objective                          : 1)Verify Edit functionality under Individual sunbiller.                                    
* Version                            : 1.0
...
public class BillerSubBillerEdit {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSubBillerEdit";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSubBillerEdit(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerLoginPage.LoginToApplication(testdatamap, Log);
	       	    Pages.BillerSubbillerPage.EditSubBiller(testdatamap, Log);
