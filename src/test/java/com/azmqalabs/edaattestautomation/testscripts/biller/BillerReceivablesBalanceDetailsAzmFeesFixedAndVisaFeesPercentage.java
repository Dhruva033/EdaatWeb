/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesFixedAndVisaFeesPercentage.
* Test Data Sheet                    : BillerReceVisaFeesPercentage
* Objective                          : Verify the fees deduction correctly  in Balance details page when AZM Fees [ Fixed] and Visa Fees[Percentage] under Receivables Balance details.
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesFixedAndVisaFeesPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceVisaFeesPercentage";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedAndVisaFeesPercentage(Map<Object, Object> testdatamap){
