/**
*
* Test Script Name                      : BillerReceivablesVerifyTransferRemarkNotes.
* Test Data Sheet                       : BillerRecVerifyTRfield.
* Objective                             : Verify that the text added in the transfer remarks field.
* Version                               : 1.0
...
public class BillerReceivablesVerifyTransferRemarkNotes {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerRecVerifyTRfield";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesVerifyTransferRemarkNotes(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.naviagteReveiableExportBiller(Log);     	        		        	
	           	Pages.BillerReceivablesExportedbillsPage.createSaveInvoiceDataWithTransferRemarkField(testdatamap,Log);	           	       	
