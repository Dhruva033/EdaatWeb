/**
*
* Test Script Name  				 : BillerAddInvoicetemplate.
* TestDataSheet                      : BillerAddInvoicesTemplates
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsPage.AddInvoicetemplate(TemplateArabic,TemplateEnglish,InvoiceType,TemplateReferancecode,TemplateDescription,Log);
