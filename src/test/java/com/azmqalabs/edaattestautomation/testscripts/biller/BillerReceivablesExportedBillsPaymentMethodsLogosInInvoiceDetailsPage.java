/**
*
* Test Script Name                      : BillerReceivablesExportedBillsPaymentMethodsLogosInInvoiceDetailsPage.
* Test Data Sheet                       : BillerExportedBillsPMLogos.
* Objective                             : verify that the available payment method appear as logo when click on view button.
* Version                               : 1.0
...
public class BillerReceivablesExportedBillsPaymentMethodsLogosInInvoiceDetailsPage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerExportedBillsPMLogos";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportedBillsPaymentMethodsLogosInInvoiceDetailsPage(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.naviagteReveiableExportBiller(Log);     	        		        	
	           	Pages.BillerReceivablesExportedbillsPage.verifyPaymentMethodsLogoInInvoiceDetailsPage(Log);	           	       	
