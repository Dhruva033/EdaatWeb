/**
*
* Test Script Name                      : ClientLoginEdaatLogo.
* TestData Sheet Name                   : ClientLoginEdaatLogo
...
public class ClientLoginEdaatLogo {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientLoginEdaatLogo";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientLoginEdaatLogo(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.ClientLoginPage.VerifyEdaatLogo(Log);
