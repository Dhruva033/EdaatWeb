/**
* Test Script Name  				 : BillerAddInvoiceCorporateClient.
* Test Data sheetName				 : BillerAddCorpIndividualClt.
* Objective     					 : To Verify Create Invoice Functionality Corporate client.
* Version      						 : 1.0
* Author       						 : Kathirvelu M
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerCorporatePage.CreateCorporateClientInvoice(testdatamap, Log);
