/**
*
* Test Script Name                   : AdminAddInvoiceIndividualClient.
* TestData Sheet Name                : AdminAddInvoiceIndividualClient
* Objective                          : Verify Create Invoice Functionality.
* Version                            : 1.0
* Author                             : Kathirvelu M
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminIndividualClientPage.CreateIndividualClientInvoice(testdatamap,Log);
