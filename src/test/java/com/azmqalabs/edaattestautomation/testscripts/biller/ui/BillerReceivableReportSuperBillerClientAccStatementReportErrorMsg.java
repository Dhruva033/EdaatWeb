/**
* Test Script Name                   : BillerReceivableReportSuperBillerClientAccStatementReportErrorMsg
* Test Data Sheet Name				 : BillerSprBlrReportClientAcount
* Objective                          : Verify Client Account Statement under Receivable reports for super biller under Reports module.
* Version                            : 1.0
* Author                             : Kathirvelu mohan
* Created Date                       : 11/08/2023
* Last Updated on                    : N/A
* Updated By                         : Obalanayak M S
* Pre-Conditions                     : 1)Valid Biller login credentials
* Epic Details                       : N/A
...
public class BillerReceivableReportSuperBillerClientAccStatementReportErrorMsg{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSprBlrReportClientAcount";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivableReportSuperBillerClientAccStatementReportErrorMsg(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Navigate to Receivable reports for super biller page");
	        	Pages.BillerReportReceivableReportforSuperBillerPage.NavigateReceivableReportsforSuperBiller(Log);
	        	
	        	Log.ReportEvent("INFO", "Step3 :  Verify Client Account Statement is successful");
	        	Pages.BillerReportReceivableReportforSuperBillerPage.ClientAccountStatementErrorMsgValidation(testdatamap);
