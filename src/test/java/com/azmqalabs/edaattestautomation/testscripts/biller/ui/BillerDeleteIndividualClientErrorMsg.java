...
* Test Data Sheet Name				 : BillerDeleteIndividualClientEr
* Objective     					 : 1)To Verify Delete Individual client page fields validation.
* Version      						 : 1.0
...
public class BillerDeleteIndividualClientErrorMsg {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerDeleteIndividualClientEr";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerDeleteIndividualClientErrorMsg(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Delete Individual Client page fields validationis Suceessful");
	        	Pages.BillerIndividualClientPage.VerifyDeleteIndClietErrorMsg(ExpectedResult);
