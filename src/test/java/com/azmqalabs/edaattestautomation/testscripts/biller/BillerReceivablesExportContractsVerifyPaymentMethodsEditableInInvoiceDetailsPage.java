/**
*
* Test Script Name                      : BillerReceivablesExportContractsVerifyPaymentMethodsEditableInInvoiceDetailsPage.
* Test Data Sheet                       : BillerExportedContPMEditable.
* Objective                             : verify that available payment methods is editable after the invoice exported.
* Version                               : 1.0
...
public class BillerReceivablesExportContractsVerifyPaymentMethodsEditableInInvoiceDetailsPage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerExportedContPMEditable";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportContractsVerifyPaymentMethodsEditableInInvoiceDetailsPage(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.naviagteReceviableExportedContracts(Log);     	        		        	
	           	Pages.BillerReceivablesExportedbillsPage.verifyExportedContractsInvoiceDetailsPaymentMethodsEditable(Log);	           	       	
