/**
*
* Test Script Name                      : BillerIndividualSubBillerStatusToggle.
* Objective                             :  Verify Grid view details
* Version                               : 1.0
* Author                                : Radhika K R
...
* Manual Testcase Name                  : BillerIndividualSubBillerStatusToggle.
* Epic Details                          : N/A
...
public class BillerIndividualSubBillerStatusToggle {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerIndividualSubBillerToggle";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerIndividualSubBillerStatusToggle(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSubbillerPage.ActivateDeactivate(testdatamap, Log);
