/**
*
* Test Script Name                   : BillerReceivablesBalanceDetailsAzmFeesFixedMadaFeesFixed.
* Test Data Sheet                    : BillerAzmAndMadaFeesFixed
* Objective                          : Verify  the fees deduction correctly in   Balance details page when AZM Fees [ Fixed ] and MADA Fees[ Fixed ]
* Version                            : 1.0
...
public class BillerReceivablesBalanceDetailsAzmFeesFixedMadaFeesFixed {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAzmAndMadaFeesFixed";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedMadaFeesFixed(Map<Object, Object> testdatamap){
