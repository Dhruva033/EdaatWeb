...
* Test Script Name                   : MyBillsVerifyAvailablePaymentMethodAssignedToBillerAccount
* Test Data Sheet Name				 : MyBillsvalid
* Objective                          : verify that the available payment method on my bills page is the same one assigned in the biller's account under My Bills module
* Version                            : 1.0
...
public class MyBillsVerifyAvailablePaymentMethodAssignedToBillerAccount {
	
	// DECLARATION SECTION
	  static String TestDataTab="MyBillsPaymentMethod";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public MyBillsVerifyAvailablePaymentMethodAssignedToBillerAccount(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.MyBillsPage.VerifyAvailablePaymentMethodAssignedToBillerAccount(testdatamap,Log);
