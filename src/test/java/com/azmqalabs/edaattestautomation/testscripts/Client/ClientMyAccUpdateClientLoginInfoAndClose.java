/**
*
* Test Script Name                      : ClientInvalidLogin.
* TestData Sheet Name                   : ClientUpdateClientLoginInfo
* Objective                             : Update Client Login Info.
* Version                               : 1.0
* Author                                : Kathirvelu M
* Created Date                          : 04/09/2023
* Last Updated on                       : N/A
* Updated By                            : N/A
* Pre-Conditions                        : 1)Client logged in with valid credentials
* Epic Details                          : N/A
...
public class ClientMyAccUpdateClientLoginInfoAndClose {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientUpdateClientLoginInfo";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientMyAccUpdateClientLoginInfoAndClose(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.ClientMyAccountPage.UpdateClientLoginInfoClose(testdatamap,Log);
