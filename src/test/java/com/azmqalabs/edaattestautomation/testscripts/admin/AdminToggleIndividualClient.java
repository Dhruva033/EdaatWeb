/**
*
* Test Script Name                   : AdminToggleIndividualClient.
* TestData Sheet Name                : AdminToggleIndividualsClient
* Objective                          : Verify Client account status toggle.
* Version                            : 1.0
* Author                             : Kathirvelu M
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminIndividualClientPage.ActivateDeactivate(testdatamap,Log);
