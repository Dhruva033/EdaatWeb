/**
*
* Test Script Name                   : BillersystemmanagementDeacttoActMaker2
* TestDataSheet                      : BillerSystemMgmtDeacttoActM2
* Objective                          : Verify to save the activation info by maker
* Version                            : 1.0
...
public class BillersystemmanagementDeacttoActMaker2 {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSystemMgmtDeacttoActM2";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillersystemmanagementDeacttoActMaker2(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSystemMangementPage.DeactoAct2(testdatamap,Log);
