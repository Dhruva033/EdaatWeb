/**
* Test Script Name                   : AdminSystemMagmtCorporateClientSettingsBtnErrorMsg
* TestData Sheet Name                : AdminSysMgmCorpClientSettings
...
public class BillerSystemMagmtCorporateClientSettingsBtnErrorMsg{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSysMgmCorpClientSettings";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSystemMagmtCorporateClientSettingsBtnErrorMsg(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	//Actual Test steps
	        	Log.ReportEvent("INFO", "Step1 : Verify Admin Application Launched Sucessfully");
	           	Pages.InvokeApplicationPage.launchApplication();	        
	        	Pages.InvokeApplicationPage.Chooseoptions(Log);	
	        	
	        	Log.ReportEvent("INFO", "Step2 : Verify User Able to Register or Sign Up Succssfully");
	        	Pages.BillerSignUpPage.BillerRegisterWithNewUserID(testdatamap,Log);
	        	
	        	Log.ReportEvent("INFO", "Step3 : Verify Admin Login is Suceessful");
	        	Pages.BillerLoginPage.clickOnBillerLogin();
	        	Pages.BillerLoginPage.LoginToApplication(testdatamap,Log);
	        	
	        	Log.ReportEvent("INFO", "Step4: Verify corporate client settings button Error Message is Sucessful");
	        	Pages.BillerSystemMangementPage.CorporateClientSettingsBtnErrorMsg(testdatamap);
