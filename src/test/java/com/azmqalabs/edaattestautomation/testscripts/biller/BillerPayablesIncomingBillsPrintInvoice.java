/**
*
* Test Script Name                   : BillerPayablesIncomingBillsPrintInvoice
* Test Data Sheet                    : BillerPayablesPrintInvoice
* Objective                          : verify that the available payment methods appears when print an invoice.
* Version                            : 1.0
...
public class BillerPayablesIncomingBillsPrintInvoice{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerPayablesPrintInvoice";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerPayablesIncomingBillsPrintInvoice(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerPayablesPage.verifyPayablesIncomingBillsPrintInvoice(testdatamap, Log);
