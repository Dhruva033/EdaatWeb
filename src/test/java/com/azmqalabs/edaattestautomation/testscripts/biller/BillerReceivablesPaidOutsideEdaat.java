/**
*
* Test Script Name                      : BillerReceivablesPaidOutsideEdaat.
* Test Data Sheet                       : BillerSearchPaidOutside.
* Objective                             : Verify Search functionality in Paid outside edaat under Receivables module.
* Version                               : 1.0
...
public class BillerReceivablesPaidOutsideEdaat {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSearchPaidOutside";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesPaidOutsideEdaat(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            Pages.BillerReceivablesPaidOutsideEdaatPage.naviagtePaidOusideEdaat(Log);	        	
	            Pages.BillerReceivablesPaidOutsideEdaatPage.verifySearchPaidOutsideBills(testdatamap, Log);	       	
