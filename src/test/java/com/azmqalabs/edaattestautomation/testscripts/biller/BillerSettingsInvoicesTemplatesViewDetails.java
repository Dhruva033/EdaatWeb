/**
*
* Test Script Name                      : BillerSettingsInvoicesTemplatesVariable.
* TestDataSheet                         : BillerInvoiceTemplateVariable
* TestDataSheet                         : BillerInvoiceTemplateVariable
* Objective                             : Verify Biller Invoice template variables.
* Version                               : 1.0
...
public class BillerSettingsInvoicesTemplatesViewDetails {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerInvoiceTemplateVariable";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsInvoicesTemplatesViewDetails(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsPage.navigateTemplate(Log);
	        	
	        	Pages.BillerSettingsPage.verfiyViewInvoiceTemplate(testdatamap,Log);
