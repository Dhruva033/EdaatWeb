/**
* Test Script Name                   : BillerExportDeactiveViewCorporateClient
* Test Data SheetName				 : BillerExportDeactiveViewCorp
* Objective                          : Verify Grid view details for corporate client
* Version                            : 1.0
* Author                             : Kathirvelu M
* Created Date                       : 
* Last Updated on                    : N/A
...
public class BillerExportDeactiveViewCorporateClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerExportDeactiveViewCorp";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerExportDeactiveViewCorporateClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerCorporatePage.Action(Action, Log);
