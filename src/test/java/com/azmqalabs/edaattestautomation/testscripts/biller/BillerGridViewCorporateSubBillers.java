...
* Script Name  : BillerGridViewIndividualClient.

* Scenario     : Verify View Invoice Functionality.
...
public class BillerGridViewCorporateSubBillers {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerGridViewCorporateSubBillr";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerGridViewCorporateSubBillers(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSubbillerPage.TableGridview(testdatamap, Log);
