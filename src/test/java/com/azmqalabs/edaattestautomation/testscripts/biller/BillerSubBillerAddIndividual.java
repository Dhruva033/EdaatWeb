...
public class BillerSubBillerAddIndividual {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSubBillerAddIndividual";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSubBillerAddIndividual(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSubbillerPage.SubBillerIndividual(testdatamap, Log);
