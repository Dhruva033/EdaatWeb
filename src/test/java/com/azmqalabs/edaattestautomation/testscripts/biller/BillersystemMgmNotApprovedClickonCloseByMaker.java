/**
*
* Test Script Name                   : BillersystemMgmNotApprovedClickonCloseByMaker
* TestDataSheet                      : BillerSystemMgmtNotAppClose
* Objective                          : Verify to enter valid  activation info for deactivated biller by maker
* Version                            : 1.0
* Author                             : Kathirvelu Mohan
* Created Date                       : 13/06/2023
* Last Updated on                    : N/A
* Updated By                         : Obalanayak M S
* Pre-Conditions                     : 1)Maker Login Credentials 2) Biller Account
* Epic Details                       : N/A
...
public class BillersystemMgmNotApprovedClickonCloseByMaker {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSystemMgmtNotAppClose";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillersystemMgmNotApprovedClickonCloseByMaker(Map<Object, Object> testdatamap){
