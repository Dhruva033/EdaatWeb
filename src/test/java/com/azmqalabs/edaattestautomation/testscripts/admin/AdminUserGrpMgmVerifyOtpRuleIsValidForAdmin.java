/**
*
* Test Script Name                   : AdminUserGrpMgmVerifyOtpRuleIsValidForAdmin
* Test Data Sheet Name				 : AdminGrpMgmOtpRuleValid
* Objective                          : Verify that this OTP Rule is valid only for the Admin under Users Management module
* Version                            : 1.0
...
public class AdminUserGrpMgmVerifyOtpRuleIsValidForAdmin {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminGrpMgmOtpRuleValid";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminUserGrpMgmVerifyOtpRuleIsValidForAdmin(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminUserMngGrpsMngPage.naviagteGroupManagement(Log);
	        	
	        	Pages.AdminUserMngGrpsMngPage.verifyOtpRuleIsOnlyValidForAdmin(Log);
