/**
*
* Test Script Name                   : AdminSettingsBillsCancellationErrorMsg 
* TestData Sheet Name                : AdminBillsCancellationErrMsg 
* Objective                          : Verify to Bills Cancellation error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminSettingsBillsCancellationErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminBillsCancellationErrMsg";  
	...
	public AdminSettingsBillsCancellationErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminSettingsPage.VerifyBillsCancelationErrorMsg(testdatamap);
