/**
*
* Test Script Name                   : ClientPayablesIncomingBillsVerifyNewlyAddedPaymentMethodSearchDropdown
* Test Data Sheet Name				 : ClientIncomingBillsNewPmtSearch
* Objective                          : Verify Add new search criteria in incoming bills page for the payment method 
* Version                            : 1.0
...
public class ClientPayablesIncomingBillsVerifyNewlyAddedPaymentMethodSearchDropdown {
	
	// DECLARATION SECTION
	  static String TestDataTab="ClientIncomingBillsNewPmtSearch";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public ClientPayablesIncomingBillsVerifyNewlyAddedPaymentMethodSearchDropdown(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	// LOGIN WITH COMMON USER ID
	        	Pages.ClientPayablesIncomingBillsPage.VerifyNewAddedPaymentMethodSearchDropdown(Log);
