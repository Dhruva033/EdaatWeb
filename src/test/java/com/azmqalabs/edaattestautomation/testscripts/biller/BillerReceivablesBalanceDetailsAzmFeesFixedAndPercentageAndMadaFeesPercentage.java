...
public class BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndMadaFeesPercentage {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceivablesMadaFeesPer";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesBalanceDetailsAzmFeesFixedAndPercentageAndMadaFeesPercentage(Map<Object, Object> testdatamap){
