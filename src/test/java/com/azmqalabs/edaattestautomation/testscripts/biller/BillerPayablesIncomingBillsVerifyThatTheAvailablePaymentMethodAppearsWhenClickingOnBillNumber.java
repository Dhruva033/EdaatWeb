/**
*
* Test Script Name                   : BillerPayablesIncomingBillsVerifyThatTheAvailablePaymentMethodAppearsWhenClickingOnBillNumber
* Test Data Sheet                    : BillerPayPaymentMethods
* Objective                          : verify that the available payment method appears when clicking on bill number -contract number Under payables module
* Version                            : 1.0
...
public class BillerPayablesIncomingBillsVerifyThatTheAvailablePaymentMethodAppearsWhenClickingOnBillNumber{
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerPayPaymentMethods";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerPayablesIncomingBillsVerifyThatTheAvailablePaymentMethodAppearsWhenClickingOnBillNumber(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerPayablesPage.verifyPaymentMethodsAppearAfterClickingOnBillNumebr(testdatamap,Log);
