/**
*
* Test Script Name                   : AdminReportsIndividualClientErrorMsg 
* TestData Sheet Name                : AdminIndivClientReportErrMsg
* Objective                          : Verify Individual client report error message
* Version                            : 1.0
* Author                             : Kathirvelu M
...
public class AdminReportsIndividualClientErrorMsg {

	// DECLARATION SECTION
	static String TestDataTab="AdminIndivClientReportErrMsg";  
	...
	public AdminReportsIndividualClientErrorMsg(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Pages.AdminReportsAdminReportsPage.VerifyIndividualClientReportErrorMsg(testdatamap,Log);
