 /**
* Test Script Name                   : AdminReceiReportsSadedPayment.
* TestData sheet Name                : AdminReceReportsSadadPayment.
* Objective                          : Verify to generate Sadad Payments Report under Receivables Reports.
* Version                            : 1.0
* Author                             : Kathirvelu Mohan
* Created Date                       : 07/06/2023
* Last Updated on                    : N/A
* Updated By                         : Radhika K R
* Pre-Conditions                     : 1)Admin valid Login credentials.                                       
* Epic Details                       : N/A
...
import com.azmqalabs.edaattestautomation.apppages.admin.pages.AdminReportsReceivablesReportsPage;
...
public class AdminReceiReportsSadedPayment {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReceReportsSadadPayment";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReceiReportsSadedPayment(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReportsReceivablesReportsPage.NavigateTOReceivablesReports(Log);
	        	
	        	Pages.AdminReportsReceivablesReportsPage.VerifySadedPaymentsReport(testdatamap,Log);
