/**
*
* Test Script Name                      : BillerReceivablesExportBillsTransferRemarksField.
* Test Data Sheet                       : BillerReceivableTransferRemark.
* Objective                             : Verify that the transfer remarks field appears when choosing a one-time template
* Version                               : 1.0
* Author                                : Kalpana I R
...
public class BillerReceivablesExportBillsTransferRemarksField {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerReceivableTransferRemark";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportBillsTransferRemarksField(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	            ...
	            Pages.BillerReceivablesExportedbillsPage.createSaveInvoiceDataWithTransferRemark(testdatamap, Log);
